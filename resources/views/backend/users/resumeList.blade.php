...
<div class="content-wrapper" style="min-height: 225px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Users Resume</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
		  <div class="table-responsive">
			<table class="table m-0 table-grid" cellspacing="0" width="100%" role="grid" data-url="{{ route('admin.users.getResumeList') }}">
			  <thead>
				<tr>
				  <th data-id="resume_name" data-orderable="false" data-searchable="false">Resume Name</th>
				  <th data-id="user" data-orderable="false" data-searchable="false">Users</th>
				  <th data-id="name" data-orderable="false" data-searchable="false">name</th>
				  <th data-id="email" data-orderable="false" data-searchable="false">Email</th>
				  <th data-id="last_modify" data-orderable="false" data-searchable="false">Last Modify</th>
