...
@section('page-title','Add Admin Page')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin.admins') }}" class="btn btn-block bg-gradient-info">Admin List</a></li>
      ...
      <div class="row" style="margin-top:20px">	 
        ...
        <div class="col-md-8">
			<div class="error msg_div"></div>
					<form class="action-form" role="form" http-type="post" method="post" data-url="{{route('admin.save_admin')}}" onsubmit="Validate_form();">
					
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					  <div class="card card-primary">
						<div class="card-header">
						  <h3 class="card-title">Admin Basic Detail</h3>
