    ...
    <!-- Content Header (Page header) -->
     <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="display: inline-block;">Sub Admin List</h1>
		  ...
		  <button type="submit"><i class="fa fa-search"></i></button-->
            ...
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('admin.add_admin')}}" class="btn btn-block bg-gradient-info">Add New Admin</a></li>
              ...
              <div class="card bg-light">
                ...
                <div class="card-footer">
                  <div class="text-right">
					@if($user->is_ban == '1')
						<a href="javascript:void(0)" title="Click to Unlock this admin." class="btn btn-sm btn-info" onclick="lock_unlock_admin({{$user->id}},'0')">
						  <i class="fas fa-lock"></i>
						</a>
					@elseif($user->is_ban == '0')
						<a href="javascript:void(0)" title="Click to Lock this Admin." class="btn btn-sm btn-info" onclick="lock_unlock_admin({{$user->id}},'1')">
						  <i class="fas fa-unlock"></i>
						</a>
					@endif
					<a onclick="return confirm('Are you sure ?');" href="{{route('admin.user-delete',['id' => $user->id])}}" class="btn btn-sm btn-danger">
...
@push('after-scripts')
	<script>
		...
		function lock_unlock_admin(id,action){
			$.ajax({
				type : 'post',
				url  : '{{route("admin.lock_admin")}}',
