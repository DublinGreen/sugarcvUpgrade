...
<head>
  ...
  <title>Admin Sugar CV | Log in</title>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{url('admin_css/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}">
  <!-- Theme style -->
    ...
    <div class="card-body login-card-body">
	 ...
	 <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="data[username]"  placeholder="Email">
...
<!-- AdminLTE App -->
<script src="{{url('admin_css/dist/js/adminlte.min.js')}}"></script>
