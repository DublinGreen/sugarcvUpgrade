...
<div class="content-wrapper" style="min-height: 225px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Work Experience</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
		  <div class="table-responsive">
			<table class="table m-0 table-grid" cellspacing="0" width="100%" role="grid" data-url="{{ route('admin.getWorkExp', compact('id')) }}">
			  <thead>
				<tr>
				  <th data-id="job_title" data-orderable="false" data-searchable="false">Job title</th>
				  <th data-id="employer" data-orderable="false" data-searchable="false">Employer</th>
				  <th data-id="city" data-orderable="false" data-searchable="false">City</th>
				  <th data-id="state" data-orderable="false" data-searchable="false">State</th>
