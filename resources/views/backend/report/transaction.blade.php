      ...
      <div class="container-fluid">
        ...
        <div class="row">
              <div class="table-responsive">
                <table class="table table m-0 table-grid" cellspacing="0" width="100%" role="grid" data-url="{{ route('admin.report.getTransaction') }}">
                  <thead>
                    <tr>
                      <th data-id="user" data-orderable="false" data-searchable="false">User</th>
                      ...
                      <th data-id="created_at" data-orderable="false" data-searchable="false">Date</th>
                    </tr>
                  </thead>
                  <tbody>
                  </tbody>
