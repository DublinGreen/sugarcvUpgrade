   ...
   <section id="services" class="education-detail-before">
	   ...
	   <div class="container">
		   ...
		   <div class="row about-container">
			  <div class="col-lg-8 " >
				 <h2 class="page-title">Finally, let’s work on your summary</h2>
				 <strong>Here’s what you need to know:</strong>
				 <p class="mt-2" style="line-height:28px">Your summary shows employers you’re right for their job We’ll help you write a great one with expert content you can customize
				</p>
			  </div>
			...
			<div class="row footer-btn">
				<div class="col-md-6 col-lg-6 col-sm-12">
					<a class="c-btn btn-default btn-back" href="{{route('work-skills')}}">Back</button></a>
				</div>
				<div class="col-md-6 col-lg-6 col-sm-12 text-right">
					<a href="{{route('enter-summary')}}"  class="c-btn btn-success btn-lg" title="" >Next</a>
				</div>
			</div>
		</div>
   </section>
