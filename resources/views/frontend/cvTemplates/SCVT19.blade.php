   ...
   <div class="" >
      <div>
         <style type="text/css" id="static">
            ...
            /* document */
            #document.skn-trz9{color:black;line-height:16px;font-variant-ligatures:none;/*min-height:1250px;*/box-sizing:border-box;word-wrap:break-word}
            ...
            #document.skn-trz9 .address .singlecolumn{margin-left:0!important;color:#fff;}
            #document.skn-trz9 .resumeTitle{font-style:arial;font-weight:bold; text-align:center;text-decoration:color:#000}}
            /* Heading */
            ...
            #document.skn-trz9 .firstparagraph{margin-top:15px}
            /* section */
            ...
            #document.skn-trz9 .left-box{padding-left:2;padding-right:0px;border:none;}
			#document.skn-trz9 .right-box{padding-left:0;padding-right:20px;border:none;}
            ...
            #document.skn-trz9 .right-box .paddedline.date-content{position:absolute;font-weight:700;margin-left:197px;width:125px}
            #document.skn-trz9 .paragraph{position:relative; padding-left:0px;}
            #document.skn-trz9 .summary .singlecolumn{margin-left:0;color:#fff;padding-right:15px;text-align:justify;}
            #document.skn-trz9 .right-box{display:inline-block;float:right;l;letter-spacing:0.2px; background-color:#FFFFFF;color:#000;}
			#document.skn-trz9 .left-box{display:inline-block;float:left;letter-spacing:0.2px; color:#000000;}
			...
			#document.skn-trz9 .topsections .left-box {width:252;float: left;padding-bottom: 0;padding-left:;padding-right: 0;}
			#document.skn-trz9 .topsections .right-box {padding-bottom: 0;padding-left:15;width:355;text-align:left;}
         ...
         <style type="text/css" id="dynamic" data-time="Tue May 26 2020 17:35:58 GMT+0530 (India Standard Time)">
            ...
            #document.skn-trz9 .paragraph{margin-top:{{isset($pdf_view)?'5px':'15px'}} }
            ...
            #document.skn-trz9 .heading{line-height:22px;padding-left:0px;}
            #document.skn-trz9 .sectiontitle1{font-size:16px;color:#fff;font-weight:bold; text-transform: uppercase;}
			#document.skn-trz9 .sectiontitle2{font-size:16px;color:#000000;font-weight:bold; text-transform: uppercase;}
			#document.skn-trz9 .sectiontitle1:after {}
			#document.skn-trz9 .sectiontitle2:after { }
			 
            #document.skn-trz9 .left-box{width:210px}
			#document.skn-trz9 .right-box{width:61%;}
            ...
            #displayResume #document.skn-trz9.document{/*min-height:1220px;*/}
            ...
            #document.skn-trz9 > div:not(.topsections), #document.skn-trz9 > div:not(.parentContainer){min-height:auto}
			...
			#document .topsections .headimg{background:red; width: 100%; padding-left:0px !important; padding-right:0px !important; margin-top:30px}
			#document .parentContainer .left-side{padding-left:15px !important; padding-top:10px}
			#document .parentContainer .right-side{padding-right:20px}
			ul.ba {    list-style-type: none;}
			...
			#document.skn-trz9 .main{font-size:16px;color:#fff;line-height:16px; padding-top:25px;padding-left:25px;}
			 ...
			 #document.skn-trz9 .imagespace{padding-left:15px;margin-top:20px;}
			 #document.skn-trz9 .side{width:100%;height:25px;background-color:#fff;}
			 #document.skn-trz9 .left-box{width:33%;padding-right:{{isset($pdf_view)?'12px':'10px'}};}
			 #document.skn-trz9 .top1{width:100%;height:160px;}
			 #document.skn-trz9 .inner{width:95%;height:160px;background-color:#fff;margin:auto;border-radius:80px;border:3px solid #000}
			#document.skn-trz9 .left-pic{width:33%;margin-top:0px;margin-left:5px;float:left}
		 #document.skn-trz9 .right-data{width:58%;float:left;margin-top:30px;text-align:center;}
			...
			.row.about-container .resume-preview.thumb-preview.resume-animation #document.skn-trz9.vmargins {width: 616px!important;}
			 ...
			 .row.about-container .resume-preview.thumb-preview.resume-animation #document.skn-trz9 .topsections {width: 611px!important;}
			 
			 .page-finalize #document, .row.about-container .resume-preview.thumb-preview.resume-animation #document.skn-trz9.vmargins{}
			 
			 .row.about-container .resume-preview.thumb-preview.resume-animation #document.vmargins .left-side div#FIELD_FRFM{padding-left: 0!important;}
          .scvt{
		      background-color:{{isset($resume->backgroundColor)? $resume->backgroundColor:'#383735'}};
         }
          progress {
         ...
         .rename-section{
            ...
            .editcontent:hover #profile{
               padding-top:10px
            }
            @endif
            .skill_rate_1 { width: 20px;background-color: #fff;height: {{isset($pdf_view)?'5px':'3px'}};display: block;}
      .skill_rate_2 { width: 40px;background-color: #fff;height: {{isset($pdf_view)?'5px':'3px'}};display: block;}
      .skill_rate_3 { width: 60px;background-color: #fff;height: {{isset($pdf_view)?'5px':'3px'}};display: block;}
      .skill_rate_4 { width: 80px;background-color: #fff;height: {{isset($pdf_view)?'5px':'3px'}};display: block;}
      .skill_rate_5 { width: {{isset($pdf_view)?'100px':'98px'}};background-color: #fff;height: {{isset($pdf_view)?'5px':'3px'}};display: block;}
       </style>
      </div>
	  <!---------header---------------->
      ...
      <div class="scvt" style="width:@if(Request::segment(1) != 'final-resume' && Request::segment(1) != 'downloaddocument') 34.5% @elseif(isset($pdf_view)) 34.8% @else 33% @endif;height:190px;position: absolute;z-index:1;"></div>
		<div class="scvt" style="width:33%;height: {{isset($pdf_view)?'166px':'160px'}};position: absolute;z-index:1;left: {{(Request::segment(1) == 'final-resume')?'64%':'67%'}};{{isset($pdf_view)?'top: 10px':'margin-top:15px'}};"></div> 
      <div id="CONTAINER_PARENT_-1" style="position: relative;z-index:2 !important;margin-top: 15px;padding-right:15px;" class="topsections">
			<div class=""  >
			
			<div class="top1" style="height:166px;">
			<div class="inner">
				<div class="left-pic">
                        ...
                        <div class="">
                           <div class="">
                              <div id="PARAGRAPH_NAME_f7eda8ec-b653-4afd-af6e-42abfa260097" class="paragraph PARAGRAPH_NAME firstparagraph  ">
                                 <div>
                                    <div id="PARAGRAPH_NAME_f7eda8ec-b653-4afd-af6e-42abfa260097" class="paragraph PARAGRAPH_NAME firstparagraph" style="margin-top:{{isset($pdf_view)?'7px':'-2px'}} !important;margin-bottom:13px;"> 
								 <div class ="imagespace" style="cursor:pointer;margin-top:0;" id="openImageUploader" title="Change Image">
									@if(isset($resume->image))
									<img src="{{ url('images/resumeImages/') }}/{{ $resume->image }}" / style="height:130px;width:130px;border-radius:67px;border:3px solid #000;">  
									@else
									<img src="{{ url('asset_new/img/user/profile.png')}}" style="height:130px;width:130px;border-radius:67px;border:3px solid #000;"/>  
									@endif
                                 </div>
                              </div>
				...
				<div data-react-beautiful-dnd-draggable="0" class="sortable-item section-container SortableItem-sibling  data-NAME">
                  ...
                  <div id="SECTION_NAME464b9aab-d77c-4f2a-994a-4f79aa785951" class="section 	main SECTION_NAME firstsection  " data-section-cd="NAME">
                     <div class=" doc-item  editcontent " dhref="@if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif">
                        <div class="">
                           <div class="">
						   <div class="name word-break" style='color:{{isset($resume->color)? $resume->color:"#000"}};font-size:{{isset($resume->nameSize)? $resume->nameSize:"36px"}};line-height:50px;text-align:center;text-transform:uppercase; height:auto'>
                                       <span class="field" id="FIELD_FNAM">{{ $resume->first_name ?? 'Your'}}</span>
                                       <span class="field" id="FIELD_LNAM">{{ $resume->last_name ?? 'Name'}}</span>
                                    </div>
                              <div class="resumeTitle " id="FIELD_DCTL" style="color:#000;margin-top: -8px;text-transform:uppercase">{{$resume->profession ?? 'Designer'}}</div>
		 ...
		 <div id="CONTAINER" class="parentContainer" style="width:100%;clear:both;">
            <div id="CONTAINER_0" class="left-box scvt" style="margin-top:{{isset($pdf_view)?'5px':'-5px'}};">
            <div  class="sortableInner ">
			    ...
			    <div data-react-beautiful-dnd-draggable="0" class="sortable-item section-container SortableItem-sibling  data-SUMM left-side" >
                  ...
                  <div id="SECTION_SUMM879edb71-bdad-4ac5-a858-3bcc1c38ab71" class="section summary notdraggable SECTION_SUMM  noparagraph " data-section-cd="SUMM">
					 ...
					 <div class="heading" id='profile'>
                           <div class="sectiontitle sectiontitle1" id="SECTIONNAME_CNTC" style='border-bottom:1px solid #fff;color:{{isset($resume->color)? $resume->color:"#fff"}};word-wrap:break-word'>@if(isset($resume->summary)) {{!empty($resume->summary->section_title)?$resume->summary->section_title : 'Profile'}}<span class="rename-section text-rename text-primary"> RENAME</span>
                           ...
                           <div class="">
                              <div id="PARAGRAPH_SUMM_0" class="paragraph PARAGRAPH_SUMM firstparagraph placeholder-text ">
                                 ...
                                 <div class=" doc-item">
                                    ...
                                    <div class="field singlecolumn" style="padding-right:0px;" id="FIELD_FRFM" >@if(isset($resume->summary) && $resume->summary)
			   ...
			   <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-HILT" style="padding-left:15px">
                  <div class="document-tool sec-tool" id="editIcons" style="right:22px;"></div>
                  <div id="SECTION_HILT78287197-6649-4595-8d7a-51b01fd1ff77" class="section SECTION_HILT  noparagraph " data-section-cd="HILT">
				  <div class=" doc-item  editcontent " dhref="@if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif">
                        <div class="heading" >
                           <div class="sectiontitle sectiontitle1" id="SECTIONNAME_CNTC" style='border-bottom:1px solid #ffffff;color:{{isset($resume->color)? $resume->color:"#fff"}};word-wrap:break-word'>{{!empty($resume->contact_section_title)?$resume->contact_section_title:'CONTACT'}}<span class="rename-section text-rename text-primary"> RENAME</span>
				...
				<div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-HILT"style="padding-left:15px;">
                  ...
                  <div id="SECTION_HILT78287197-6649-4595-8d7a-51b01fd1ff77" class="section SECTION_HILT  noparagraph " data-section-cd="HILT">
                     <div class=" doc-item editcontent " dhref="@if(isset($resume->id))  {{ route('edit-skills',['id' => $resume->id]) }} @endif">
                        <div class="heading">
                           <div class="sectiontitle sectiontitle1" id="SECTIONNAME_HILT" style='border-bottom:1px solid #fff;color:{{isset($resume->color)? $resume->color:"#fff"}};word-wrap:break-word'>@if(isset($resume->skills)) {{!empty($resume->skills->section_title)?$resume->skills->section_title : 'SKILLS'}} <span class="rename-section text-rename text-primary"> RENAME </span>
                        ...
                        <div class="">
                           <div class="">
                              <div id="PARAGRAPH_HILT_0" class="paragraph PARAGRAPH_HILT firstparagraph placeholder-text ">
                                 <div class=" doc-item" style="color:#fff;">
                                    <div class="ratingRow">
                                       ...
                                       @if(isset($resume->skills) && $resume->skills)
                                                   ...
                                                   @foreach($skills as $skill)
                                                      <li style="margin: 0;list-style: none;{{$loop->iteration > 1 ? 'padding-top:8px;':''}}"><span class="firstspan" style="display: inline-block; padding-right:10px">{{ $skill->skill }}</span><br><span class="secondspan" style="background-color: #000;width: 100px;height: 5px; margin-top: {{isset($pdf_view)?'4px':'6px'}};border: 1px solid #000;display:inline-block;"><span class="skill_rate_{{ $skill->rating }}"></span></span><br></li>
                                                   @endforeach
                                                   @else
				 ...
				 <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-HILT  editcontent " dhref="@if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif" style="padding-left:15px;">
			   <div class="heading" style="padding-left:0px;margin-top:15px;">
                           <div class="sectiontitle sectiontitle1" id="SECTIONNAME_HILT" style='border-bottom:1px solid #fff;color:{{isset($resume->color)? $resume->color:"#fff"}};word-wrap:break-word'>{{!empty($resume->bio_section_title)?$resume->bio_section_title:'BIO DATA'}}<span class="rename-section text-rename text-primary"> RENAME</span>
					...
					<div class="biodata" style="padding-left:0px;color:white;padding-top:10px;">
               ...
               <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-HILT" style="padding-left:15px;">
                  ...
                  <div id="SECTION_HILT78287197-6649-4595-8d7a-51b01fd1ff77" class="section SECTION_HILT  noparagraph " data-section-cd="HILT">
                     <div class=" doc-item editcontent " dhref="@if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif">
                        <div class="heading">
                           <div class="sectiontitle sectiontitle1" id="SECTIONNAME_HILT" style='border-bottom:1px solid #fff;color:{{isset($resume->color)? $resume->color:"#fff"}};word-wrap:break-word'>Social Links<span class="inner-action"><a href="@if(isset($resume->id))  {{ route('edit-resume',['id' => $resume->id]) }} @endif" class="edit-section"><i class="fa fa-pencil"></i></a> <a href="javascript:;" class="btn-icon-tertiary btn-icon-move" style="right: -476px;"><i class="fa fa-arrows-alt" tabindex="0" data-react-beautiful-dnd-drag-handle="1" aria-roledescription="Draggable item. Press space bar to lift" draggable="false"></i></a></span><!--<span style="border-bottom: 4px solid white;float:right;margin-top: 4px;width: 35px;height: 18px;"></span>--></div>
                        </div>
                        <div class="">
                           <div class="">
                              <div id="PARAGRAPH_HILT_0" class="paragraph PARAGRAPH_HILT firstparagraph placeholder-text ">
                                 <div class=" doc-item" style="color:#fff;">
                                    <div class="ratingRow">
                                       <div class="ratingText" id="FIELD_SKC1">
                                          <div class="social_links" style="color: white;padding-bottom:15px;">
			   ...
			   <div id="CONTAINER_0" class="right-box" style="padding-left:10px;">
                 ...
                 <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-EDUC" style="margin-left:8px !important">
                  ...
                  <div id="SECTION_EDUCe38830c3-809a-48c9-a15b-57e04eb83e0e" class="section education SECTION_EDUC  noparagraph multi-para" data-section-cd="EDUC">
                     <div class=" doc-item editcontent " dhref="@if(isset($resume->id))  {{ route('editEducationList',['id' => $resume->id]) }} @endif">
                        <div class="heading">
                           <div class="sectiontitle sectiontitle2" id="SECTIONNAME_EDUC" style='border-bottom:1px solid #000;color:{{isset($resume->color)? $resume->color:"#000"}};word-wrap:break-word' >@if(isset($resume->resume_education_detail[0])) {{!empty($resume->resume_education_detail[0]->section_title)?$resume->resume_education_detail[0]->section_title : 'EDUCATION'}}<span class="rename-section text-rename text-primary"> RENAME</span>
                              ...
                              <span class="eduname"><i class="fa fa-check"></i></span> <span class="cancel">Cancel</span></span>@else EDUCATION @endif<span class="inner-action" data-resumeId="{{ isset($resume->id)? $resume->id:''}}" data-href="{{route('deleteEducation')}}"><a href="javascript:;" class="del-section"><i class="fa fa-trash"></i></a> <a href="@if(isset($resume->id))  {{ route('editEducationList',['id' => $resume->id]) }} @endif" class="edit-section"><i class="fa fa-pencil"></i></a>
                               <a href="javascript:;" class="btn-icon-tertiary btn-icon-move" style="right: -476px;"><i class="fa fa-arrows-alt" tabindex="0" data-react-beautiful-dnd-drag-handle="1" aria-roledescription="Draggable item. Press space bar to lift" draggable="false"></i></a></span></span><!--<span style="border-bottom: 4px solid #000;float:right;margin-top: 4px;width: 35px;height: 18px;"></span>--></div>
                        </div>
                        <div class="">
                            <div class="">
								...
								<div class=" doc-item">
								   <div class="singlecolumn" style="">
									  ...
									  <div class="paddedline " >
										 <span class="txtBold companyname" id="FIELD_SCHO">{{ $education->school_name }}</span><span> - </span>
										 <span class="txtBold jobcity" id="FIELD_SCIT">{{ $education->school_location }}&nbsp;|&nbsp;{{ date('M, Y', strtotime($education->graduation_start_date)) }} - {{ $education->current == '1' ? 'Current' : date('M, Y', strtotime($education->graduation_end_date)) }}</span><span></span>
								...
								<div class=" doc-item">
								   <div class="singlecolumn">
									  <div class="paddedline date-content" >
										 ...
										 <span class="jobdates" id="FIELD_GRED" format="%Y-%m">03/2015</span>
									  </div>
                  ...
                  <div class="document-tool sec-tool" id="editIcons" style="right: -22px;"></div>
                  <div id="SECTION_EXPR06fafd67-c5ae-45e8-b4a1-ed0f75d06194" class="section experience SECTION_EXPR  noparagraph multi-para" data-section-cd="EXPR" style="padding-left:10px;">
                     <div class=" doc-item  editcontent " dhref="@if(isset($resume->id)) {{ route('editExprList',['id' => $resume->id]) }} @endif">
                        <div class="heading">
                           <div class="sectiontitle sectiontitle2" id="SECTIONNAME_EXPR" style='border-bottom:1px solid #000;color:{{isset($resume->color)? $resume->color:"#000"}};word-wrap:break-word'>@if(isset($resume->resume_work_detail[0])) {{!empty($resume->resume_work_detail[0]->section_title)?$resume->resume_work_detail[0]->section_title : 'EXPERIENCE'}}<span class="rename-section text-rename text-primary"> RENAME</span>
							...
							@foreach($resume->resume_work_detail as $workhistory)
                              <div id="PARAGRAPH_EXPR_0" class="paragraph PARAGRAPH_EXPR firstparagraph placeholder-text ">
                                 <div class=" doc-item">
									...
									<span class="jobtitle txtBold" id="FIELD_JTIT">{{  $workhistory->job_title  }}&nbsp;|&nbsp;{{  $workhistory->employer  }}</span>
                                       </span>
									<div class="singlecolumn" style="">
									 <div style="">
                                      ...
                                      <!-- <span class="jobtitle txtBold" id="FIELD_JTIT">{{  $workhistory->employer  }} </span>-->
                                       ...
                                       <span class="paddedline locationGap " dependency="COMP|JSTA|JCIT">
										   ...
										   <span class="txtBold jobstate" id="FIELD_JSTA">{{  $workhistory->state  }},</span>
										   <!--<span dependency="COMP+JCIT|JSTA">, </span>-->
										   <span class="jobcity txtBold" id="FIELD_JCIT">{{  $workhistory->country  }}&nbsp;|&nbsp;{{ date('M, Y', strtotime($workhistory->start_date)) }} - {{ $workhistory->is_current == '1' ? 'Current' : date('M, Y', strtotime($workhistory->end_date)) }}</span>
                                       </span>
                                       <span class="jobline" id="FIELD_JDES" style="margin-left: 0px;">
                              ...
                              <div id="PARAGRAPH_EXPR_-1" class="paragraph PARAGRAPH_EXPR placeholder-text ">
                                 <div class=" doc-item">
                                    <div class="singlecolumn">
                                       ...
                                       <span class="companyname" id="FIELD_COMP">Target</span><span dependency="COMP+JCIT|JSTA">, </span><span class="jobcity" id="FIELD_JCIT">San Francisco</span>
									   <!--<span dependency="JCIT+JSTA">, </span>-->
									   <span class="jobstate" id="FIELD_JSTA">CA</span>
                                       </span>
			  ...
			  <div class="section sortable-item section-container SortableItem-sibling  data-SEC" style="padding-left:10px;">
				 <div id="SECTION_EDUC411a31aa-7167-4080-837f-be30a3388e31" class=" SECTION_EDUC  noparagraph multi-para" data-section-cd="SEC">
					<div class=" doc-item editcontent " dhref="@if(isset($resume->id)) {{ route('edit-section',['id' => $resume->id]) }} @endif">
					   <div class="heading">
						  <div class="sectiontitle sectiontitle2" id="SECTIONNAME_SEC" style='border-bottom:1px solid #000;color:{{isset($resume->color)? $resume->color:"#000"}};word-wrap:break-word'>@if(isset($resume->extraSection->title)) {{$resume->extraSection->title}} <span class="rename-section text-rename text-primary">Rename</span>
                            <span class="titleupdate" style="display:none;"><input type="text" data-link="extrasection" value="{{$resume->extraSection->title}}" ><span class="eduname"><i class="fa fa-check"></i></span> <span class="cancel">Cancel</span></span>@else  @endif<span class="inner-action" data-resumeId="{{ isset($resume->id)? $resume->id:''}}" data-href="{{route('deletsection')}}"><a href="javascript:;" class="del-section"><i class="fa fa-trash"></i></a> <a href="@if(isset($resume->id))  {{ route('edit-section',['id' => $resume->id]) }} @endif" class="edit-section"><i class="fa fa-pencil"></i></a> <a href="javascript:;" class="btn-icon-tertiary btn-icon-move" style="right: -476px;"><i class="fa fa-arrows-alt" tabindex="0" data-react-beautiful-dnd-drag-handle="1" aria-roledescription="Draggable item. Press space bar to lift" draggable="false"></i></a></span><!--<span style="border-bottom: 4px solid #000;float:right;margin-top: 4px;width: 35px;height: 18px;"></span>--> </div>
					   </div>
					   <div class="">
						  <div class="" style="padding-left:0px;padding-top:10px;">
