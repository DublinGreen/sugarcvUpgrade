...
<div>
   ...
   #backgroundInactive{
      ...
      #document.skn-trz7 .resumeTitle{color:#002e58;font-style:italic;font-weight:400;font-familys: cursive;}
      /* Heading */
      #document.skn-trz7 .heading{border-bottom:2px solid #d5d6d6;padding:0 0 0px;letter-spacing:0;font-weight:bold;line-height:15px;margin-bottom:10px;width:100%}
      ...
      #document.skn-trz7 .left-box{box-sizing:initial;float:left;letter-spacing:0.2px}
      #document.skn-trz7 .right-box .section:first-child,#document.skn-trz7 .left-box .section:first-child{padding-top:0px!important}
      #document.skn-trz7 .right-box .paddedline.date-content{position:relative;font-weight:700;margin-left:0;width:125px}
      #document.skn-trz7 .paragraph{position:relative;}
      #document.skn-trz7 .summary .singlecolumn{margin-left:0;font-familys: cursive;}
      #document.skn-trz7 .right-box{display:inline-block;float:right;margin-top:8px;letter-spacing:0.2px}
      ...
      #document.skn-trz7 .paragraph.datespara:after{content:'';display:table;}
      #document.skn-trz7 .topsections .left-box {float: left;padding-bottom: 10px;padding-left: 0;padding-right: 0;width: 50%;}
      #document.skn-trz7 .topsections .right-box {padding-bottom: 0;padding-left: 0;width: 50%;text-align:left;}
      div#CONTAINER_3 { padding-top: 36px;}
      #document.skn-trz7 .resumeTitle:after { content: '';display: none;border-bottom: 4px solid #000;width: 30px;padding-top: 20px;}
   ...
   <style type="text/css" id="dynamic" data-time="Tue May 26 2020 17:35:58 GMT+0530 (India Standard Time)">
      ...
      #document.skn-trz7.hmargins{padding-left:20px;padding-right:20px;width:100%}
      #document.skn-trz7 .section{padding-top:0px}
      ...
      #document.skn-trz7 .name{color:{{isset($resume->color)? $resume->color:"#002e58"}};font-size:{{isset($resume->nameSize)? $resume->nameSize:"26px"}};line-height:40px;margin-top: 20px;}
      #document.skn-trz7 .heading{line-height:22px;text-transform:uppercase;}
      #document.skn-trz7 .sectiontitle{font-size:16px;color:{{isset($resume->color)? $resume->color:"#002e58"}};vertical-align:middle;}
      #document.skn-trz7 .left-box{width:188px}
      #document.skn-trz7 .right-box .paragraph .singlecolumn{margin-left:0px}
      #document.skn-trz7 svg{stroke:#002e58}
      #document.skn-trz7 .resumeTitle{font-size:16px;color:#002e58;line-height:16%;margin-top:8px;}
      ...
      ul.ba {    list-style-type: none;}
      #document.skn-trz7 .main{font-size:16px;color:#002e58;line-height:16px; padding-top:25px;color:#fff}
      #document.skn-trz7 .imagespace{float:right;margin-top:-20px}
      #document.skn-trz7 .sectiontitle-li{font-size:16px;color:#000}
      i.fa.fa-link {background: black;color: white;padding: 5px;border-radius: 5px;margin-right: 2px;}
      div#CONTAINER_PARENT_1 .right-box {width: 64%;float: right;margin-top: 0!important;}
      ...
      /* .row.about-container .resume-preview.thumb-preview.resume-animation #document .topsections{width: 548px!important;} */
      .biodata {font-familys: cursive;}
      .address .singlecolumn > div:not(:last-child){border-bottom: 1px solid !important;}
      .address .singlecolumn .fa-stack { margin-right: 5px;}
      .address .singlecolumn .fa-stack:after {border-left: 1px solid;content: '';position: relative;left: 5px;bottom:6px}
      div#FIELD_SKC1 ul li {list-style: none !important;margin: 0 !important;}
      .skill_rate_1 { width: 15px;background-color: #000;height: 5px;display: block;}
      .skill_rate_2 { width: 30px;background-color: #000;height: 5px;display: block;}
      .skill_rate_3 { width: 45px;background-color: #000;height: 5px;display: block;}
      .skill_rate_4 { width: 60px;background-color: #000;height: 5px;display: block;}
      .skill_rate_5 { width: 75px;background-color: #000;height: 5px;display: block;}
      .address {font-familys: cursive;}
      div#SECTION_EDUCe38830c3-809a-48c9-a15b-57e04eb83e0e, div#FIELD_SKC1, span.jobline {font-familys: cursive;}
     
      #FIELD_JDES div br:first-child{
      display:none ;
      }
      @if(Request::segment(1) == "final-resume")
      #SECTIONNAME_BIOD:hover .rename-section{
      display: inline;
      }
      #SECTIONNAME_BIOD:hover .inner-action{
      display: inline;
      }
      #personal_info:hover .rename-section{
      display: inline;
      font-size: 8px;
      cursor: pointer;
      }
      #personal_info:hover .inner-action{
      display: inline;
      cursor: pointer;
      }
      #SECTIONNAME_PEXPR:hover
      .rename-section{
      display: inline;
      font-size: 8px;
      cursor: pointer;
      ...
      @endif
      .PARAGRAPH_EXPR:hover .rename-section{
      ...
      #FIELD_SKC1 li .secondspan {
    float:left;
}
      @if(isset($pdf_view))
      #FIELD_SKC1 li .firstspan {
                        /* width:105px; */
      ...
      .PARAGRAPH_EXPR .jobdates{
         width:15%;
      }
      .address .singlecolumn .fa-stack:after {border-left: 0px solid;content: '';top:10px !important;}
      .address .singlecolumn .fa-stack img {border-right: 1px solid;padding-right:3px;}
      .address .singlecolumn > div{border-bottom: 1px solid !important;margin-top:8px;}
      .address .singlecolumn > div:last-child{border-bottom: 0px solid !important;}
      @else
...
<!---------header---------------->
<div id="document" class="document fontsize fontface vmargins hmargins pagesize skn-trz7 TRZ7  ZTY">
   <div id="CONTAINER_PARENT_-1" class="topsections" style="clear: both;display: block;float: left;width: 100%;">
      <div class="" style="background-color:#ffffff" >
         <div id="CONTAINER_4" class="left-box editcontent " dhref="@if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif">
                     ...
                     <div class="">
                        <div class="">
                           <div id="PARAGRAPH_NAME_f7eda8ec-b653-4afd-af6e-42abfa260097" class="paragraph PARAGRAPH_NAME firstparagraph  ">
                              <div>
                                 <div id="PARAGRAPH_NAME_f7eda8ec-b653-4afd-af6e-42abfa260097" class="paragraph PARAGRAPH_NAME firstparagraph  ">
                                    <div class ="imagespace" style="cursor:pointer" id="openImageUploader" title="{{Request::segment(1) == "final-resume" ?'Change Image':''}}">
                                       @if(isset($resume->image))
                                       <img src="{{ url('images/resumeImages/') }}/{{ $resume->image }}" / style="height:120px;width:120px;margin-bottom:5px;">
                                       @else
                                       <img src="{{ url('asset_new/img/user/profile.png')}}" style="height:144px;width:141px;margin-bottom:5px;"/>
                                       @endif
                                    </div>
                                 </div>
                              </div>
   ...
   <div id="CONTAINER_PARENT_0" class="" style="height:35px;background-color:#f0f1f5;border-left:4px solid #000;clear: both;display: block;width: 100%;margin-top: 30px;">
      <div id="CONTAINER_0" class="left-box" style="width:58% !important">
         <p style="font-size:17px;padding-left:7px;padding-top:7px;" class="sectiontitle">
           
         <div class="heading editcontent" dhref="@if(isset($resume->id)) {{ route('edit-summary',['id' => $resume->id]) }} @endif" style="border-bottom:0px;">
         <div class="sectiontitle" id="personal_info" style='font-size:16px;color:{{isset($resume->color)? $resume->color:"#002e58"}};margin-left:5px;{{isset($pdf_view)?'padding-top:7px;':''}}'>@if(isset($resume->summary)) {{!empty($resume->summary->section_title)?$resume->summary->section_title : 'PERSONAL STATEMENT'}}<span class="rename-section text-rename text-primary"> RENAME</span>
         <span class="titleupdate" style="display:none;"><input type="text" data-link="aboutme" value="{{!empty($resume->summary->section_title)?$resume->summary->section_title : 'PERSONAL STATEMENT'}}" ><span class="eduname"><i class="fa fa-check"></i></span> <span class="cancel">Cancel</span></span>@else ABOUT ME @endif <span class="inner-action" data-resumeId="{{ isset($resume->id)? $resume->id:''}}" data-href="{{route('deletesummary')}}"><a href="javascript:;" class="del-section"><i class="fa fa-trash"></i></a> <a href="@if(isset($resume->id)) {{ route('edit-summary',['id' => $resume->id]) }} @endif" class="edit-section"><i class="fa fa-pencil"></i></a> </span></div>
         </div></p>
      </div>
      <div id="CONTAINER_0" class="right-box sectiontitle" style="width:38%">
         <p style="font-size:17px;float:right;width:100%">
           
         <div class="heading  editcontent " dhref="@if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif" style="border-bottom:0px;">
         <div class="sectiontitle" id="SECTIONNAME_BIOD" style='font-size:16px;color:{{isset($resume->color)? $resume->color:"#002e58"}};margin-right:2px;text-align:right;'>{{!empty($resume->bio_section_title)?$resume->bio_section_title:'BIO DATA'}}<span class="rename-section text-rename text-primary"> RENAME</span>
   ...
   <div id="CONTAINER" class="" style="height: auto;float:left;width:100%;clear:both;">
      <div id="CONTAINER_0" class="left-box" style="width:60% !important;border-right:4px solid #f0f1f5;height: auto;padding-left:8px;margin-top:{{isset($pdf_view)?'0px;padding-top:5px;':'-7px;'}}">
         <div data-react-beautiful-dnd-draggable="0" class="sortable-item section-container SortableItem-sibling  data-SUMM">
            ...
            <div id="SECTION_SUMM879edb71-bdad-4ac5-a858-3bcc1c38ab71" class="section summary notdraggable SECTION_SUMM  noparagraph " data-section-cd="SUMM">
               <div class="doc-item editcontent" data-id="personal_info" dhref="@if(isset($resume->id)) {{ route('edit-summary',['id' => $resume->id]) }} @endif">
                  <div class="">
                     <div class="">
                        <div id="PARAGRAPH_SUMM_0" class="paragraph PARAGRAPH_SUMM firstparagraph placeholder-text ">
                           <div class="clearfix doc-item">
                              <div class="field singlecolumn" id="FIELD_FRFM" style="">@if(isset($resume->summary) && $resume->summary)
      ...
      <div id="CONTAINER_0" class="right-box" style="width: 35%">
         <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-BIOD">
            <div class="clearfix doc-item editcontent" dhref="@if(isset($resume->id))  {{ route('edit-resume',['id' => $resume->id]) }} @endif" data-id="SECTIONNAME_BIOD">
               <div class="biodata">
   ...
   <div id="CONTAINER_PARENT_1" class="parentContainer" style="clear:both;border-top: 3px solid #f0f1f5 !important;">
      <div id="CONTAINER_1" class="left-box " style="width:35%;border-right:2px solid #E3e3e3;">
         <div class="sortableInner">
            <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-CNTC" style="padding-top:16px;">
               <!-- <div class="document-tool sec-tool" id="editIcons" style="right: -22px;">@if(isset($resume->extraSection->title)) {{$resume->extraSection->title}} <span class="rename-section text-rename text-primary">Rename</span>
               ...
               <div id="SECTION_CNTC4b959b3f-7a77-4285-9b17-82823b7d38a8" class="section SECTION_CNTC notdraggable   " data-section-cd="CNTC" style="border-top:2px solid #E3e3e3;">
                  <div class="doc-item editcontent" dhref="@if(isset($resume->id))  {{ route('edit-resume',['id' => $resume->id]) }} @endif">
                     <div class="heading">
                        <div class="sectiontitle" id="SECTIONNAME_EXPR" >
                           ...
                           <span class="fa-stack fa-lg sectiontitle-li">
                           <img src="{{ url('templates_images/scvt6/c_icon.jpeg')}}" width="27px" style="margin-top:{{isset($pdf_view)?'5px;':'2px;'}};">
                           </span>
                           <span class="field" id="" style="font-size:16px !important;position: relative;display:inline-block;vertical-align: middle;margin-top:2px">{{!empty($resume->contact_section_title)?$resume->contact_section_title:'CONTACT'}}<span class="rename-section text-rename text-primary"> RENAME</span>
                          <span class="titleupdate" style="display:none;"><input type="text" data-link="contactsection" value="{{!empty($resume->contact_section_title)?$resume->contact_section_title:'Contact'}}" ><span class="eduname"><i class="fa fa-check"></i></span> <span class="cancel">Cancel</span></span><span class="inner-action"><a href="@if(isset($resume->id))  {{ route('edit-resume',['id' => $resume->id]) }} @endif" class="edit-section"><i class="fa fa-pencil"></i></a> <a href="javascript:;" class="btn-icon-tertiary btn-icon-move" style="right: -476px;"><i class="fa fa-arrows-alt" tabindex="0" data-react-beautiful-dnd-drag-handle="1" aria-roledescription="Draggable item. Press space bar to lift" draggable="false"></i></a></span></span>
                           <!--<span style="display: inline-inline-block;"> <span><img src="{{asset('templates_images/scvt6/work.png')}}" style="padding-top:2%;" alt=""></span><span style="padding-top: 7px;padding-left: 30px;padding-bottom: 4%;">Work Experience</span> </span><span class="rename-section text-rename"> </span>-->
                        </div>
                        <!--<div class="sectiontitle" id="SECTIONNAME_CNTC">
                           <span class="fa-stack fa-lg sectiontitle-li">
                                       <img src="{{asset('templates_images/scvt6/contact.png')}}" style="margin-top: 5px" alt="">
                           		  {{-- <i class="fa fa-square fa-stack-2x"></i>
                           		  <i class="fa fa-phone fa-stack-1x fa-inverse"></i> --}}
                           		</span>
                           
                           <span style="padding-bottom:50%">Contact</span><span class="rename-section text-rename"> </span></div>-->
                     </div>
                     <div class="">
                        <div class="">
                              ...
                              <div class="clearfix doc-item">
                                 <div class="address">
                                    <div class="singlecolumn">
                                       <div dependency="STRT|CITY|STAT|ZIPC" style="width: 90%;{{isset($pdf_view)?'margin-top:10px;':''}}">
                                          <span class="fa-stack fa-lg sectiontitle-li" style="display: inline-block;{{ isset($pdf_view)?'width:14%;':'width:16%;'}}">
                                       ...
                                       <div dependency="HPHN" style="width: 90%;">
                                          <span class="fa-stack fa-lg sectiontitle-li" style="display: inline-block;{{ isset($pdf_view)?'width:14%;':'width:16%;'}}">
                                             ...
                                             <img src="{{ url('templates_images/scvt6/phone.jpg')}}" width="23px" style="{{ isset($pdf_view)?'margin-top:3px;':'margin-top:2px;'}}">
                                       ...
                                       <div dependency="EMAI" class="word-break" style="width: 90%;{{ isset($pdf_view)?'padding-bottom:5px;margin-bottom:7px;':''}}">
                                          <span class="fa-stack fa-lg sectiontitle-li" style="display: inline-block;vertical-align:top;{{ isset($pdf_view)?'width:14%;':'width:16%;'}}">
                                             <!--i class="fa fa-square fa-stack-2x"></i-->
                                             <!-- <i class="fa fa-envelope-o fa-stack-1x "></i> -->
                                             <img src="{{ url('templates_images/scvt6/mail.jpg')}}" width="23px" style="{{ isset($pdf_view)?'margin-top:3px;':'margin-top:5px;'}}">
                                       ...
                                       @if( !empty($resume->facebook) )
                                          ...
                                          <div class="word-break" style="width: 90%;">
                                          <span class="fa-stack fa-lg sectiontitle-li" style="display: inline-block;vertical-align:top;{{ isset($pdf_view)?'width:14%;':''}}">
                                             <!--i class="fa fa-square fa-stack-2x"></i-->
                                             <!-- <i class="fa fa-phone fa-stack-1x "></i> -->
                                              <img src="{{ url('templates_images/scvt6/facebook.jpg')}}" width="23px" style="margin-top:5px;">
                                             
                                           </span>
                                          <span style="display: inline-block; @if(isset($pdf_view)) margin-top:-7px;vertical-align:top; @else margin-top:3px; @endif width:78%;">
                                             <span class="field" style="word-break:break-all;">{{ $resume->facebook }}</span>
                                          </span>
                                       </div>
                                       @endif
                                       ...
                                       <div class="word-break" style="width: 90%;">
                                          <span class="fa-stack fa-lg sectiontitle-li" style="display: inline-block;vertical-align:top;{{ isset($pdf_view)?'width:14%;':''}}">
                                             <!--i class="fa fa-square fa-stack-2x"></i-->
                                             <!-- <i class="fa fa-phone fa-stack-1x "></i> -->
                                              <img src="{{ url('templates_images/scvt6/twitter.jpg')}}" width="23px" style="margin-top:5px;">
                                             
                                           </span>
                                          <span style="display: inline-block; @if(isset($pdf_view)) margin-top:-7px;vertical-align:top; @else margin-top:3px; @endif width:78%;">
                                             <span class="field" style="word-break:break-all;">{{ $resume->twitter }}</span>
                                          </span>
                                       </div>
                                       @endif
                                       ...
                                       <div class="word-break" style="width: 90%;">
                                          <span class="fa-stack fa-lg sectiontitle-li" style="display: inline-block;vertical-align:top;{{ isset($pdf_view)?'width:14%;':''}}">
                                             <!--i class="fa fa-square fa-stack-2x"></i-->
                                             <!-- <i class="fa fa-phone fa-stack-1x "></i> -->
                                              <img src="{{ url('templates_images/scvt6/linkedin.jpg')}}" width="23px" style="margin-top:5px;">
                                             
                                           </span>
                                          <span style="display: inline-block; @if(isset($pdf_view)) margin-top:-7px;vertical-align:top; @else margin-top:3px; @endif width:78%;">
                                             <span class="field" style="word-break:break-all;">{{ $resume->linkedin }}</span>
                                          </span>
                                       </div>
                                       @endif
                                       ...
                                       <div class="word-break" style="width: 90%;">
                                          <span class="fa-stack fa-lg sectiontitle-li" style="display: inline-block;vertical-align:top; {{ isset($pdf_view)?'width:14%;':''}}">
                                              ...
                                              <img src="{{ url('templates_images/scvt6/website.jpg')}}" width="23px" style="margin-top:5px;">
                                             
                                           </span>
                                          <span style="display: inline-block; @if(isset($pdf_view)) margin-top:-7px;vertical-align:top; @else margin-top:3px; @endif width:78%;">
                                             <span class="field" style="word-break:break-all;">{{ $resume->website }}</span>
                                          </span>
                                       </div>
                                       @endif
                                    </div>
            ...
            <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-EDUC" style="padding-top:16px">
               <div class="document-tool sec-tool" id="editIcons" style="right: -22px;"></div>
               <div id="SECTION_EDUCe38830c3-809a-48c9-a15b-57e04eb83e0e" class="section education SECTION_EDUC  noparagraph multi-para" data-section-cd="EDUC" style="border-top:2px solid #E3e3e3;">
                  <div class="editcontent doc-item" dhref="@if(isset($resume->id))  {{ route('edit-section',['id' => $resume->id]) }} @endif">
                     <div class="heading" style="display:inline-block;">
                        <span>  <span class="fa-stack fa-lg sectiontitle-li">
                           <img src="{{ url('templates_images/scvt6/e_icon.jpeg')}}" width="27px" style="margin-top:{{isset($pdf_view)?'4px;':'2px;'}}">
                           </span>
                                   </span>
                        <span class="sectiontitle" id="SECTIONNAME_EXPR" style='padding-bottom:7px;margin-top:10px;font-size:16px;color:{{isset($resume->color)? $resume->color:"#002e58"}}'>@if(isset($resume->resume_education_detail[0])) {{!empty($resume->resume_education_detail[0]->section_title)?$resume->resume_education_detail[0]->section_title : 'EDUCATION'}} <span class="rename-section text-rename text-primary">Rename</span>
            ...
            <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-HILT" style="padding-top:16px">
               <div class="document-tool sec-tool" id="editIcons" style="right: -22px;"></div>
               <div id="SECTION_HILT78287197-6649-4595-8d7a-51b01fd1ff77" class="section SECTION_HILT  noparagraph " data-section-cd="HILT" style="border-top:2px solid #E3e3e3;">
                  <div class="editcontent doc-item" dhref="@if(isset($resume->id))  {{ route('edit-skills',['id' => $resume->id]) }} @endif">
                     <div class="heading" style="display:inline-block;">
                        <span >	<span class="fa-stack fa-lg sectiontitle-li">
                           <img src="{{ url('templates_images/scvt6/s_icon.jpeg')}}" width="27px" style="margin-top:{{isset($pdf_view)?'4px;':'2px;'}};">
                           </span>
                                   </span>
                        <span class="sectiontitle" id="SECTIONNAME_EXPR" style="display: inline-block;">
                                 ...
                                 <div class="ratingRow">
                                    <div class="ratingText" id="FIELD_SKC1">
                                       <ul>
                                          ...
                                          <li><span class="firstspan" style="">{{ $skill->skill }} </span><br><span class="secondspan" style="background-color: #fff;width: 75px;height: 5px; margin-top: 6px;margin-right: 13px;border: 1px solid #000;"><span class="skill_rate_{{ $skill->rating }}"></span></span><br></li>
                                          @endforeach
                                          @endif
                                          @else
               ...
               @if( ( $resume->facebook != '' ) || ( $resume->twitter != '' ) || ( $resume->linkedin != '' ) || ( $resume->website != '' ) )
               	<div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-SOCL">
               	 <div class="heading" style="margin-top:20px;">
               		   <div class="sectiontitle" id="SECTIONNAME_SOCL">
               					<span class="fa-stack fa-lg sectiontitle-li" style="    text-align: center;">
               					  <i class="fa fa-link" aria-hidden="true"></i>
               					</span>Social Links<span class="rename-section text-rename"> </span></div>
               		</div>
      ...
      <div id="CONTAINER_2" class="right-box right-side" style="width: 58%">
         <div class="sortableInner">
            <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-EXPR" style="margin-top:{{isset($pdf_view)?'15px !important':''}};">
               <div class="document-tool sec-tool" id="editIcons" style="padding-top:16px;"></div>
               <div id="SECTION_EXPR06fafd67-c5ae-45e8-b4a1-ed0f75d06194" class="section experience SECTION_EXPR  noparagraph multi-para" data-section-cd="EXPR" style="border-top:2px solid #E3e3e3;">
                  <div class="editcontent doc-item" dhref="@if(isset($resume->id)) {{ route('editExprList',['id' => $resume->id]) }} @endif">
                     <div class="heading" style="display:inline-block;margin-bottom:16px;">
                        <span>  <span class="fa-stack fa-lg sectiontitle-li">
                           <img src="{{ url('templates_images/scvt6/e_icon.jpeg')}}" width="27px" style="margin-top:{{isset($pdf_view)?'4px;':'2px;'}};">
                           </span>
                                   </span>
                        <!-- <span class="field" id="" style="font-size:16px !important;position: relative;vertical-align: middle;margin-top:10px"> -->
                        <span class="sectiontitle" id="SECTIONNAME_PEXPR" style="margin-top: 10px;height: 28px;">@if(isset($resume->resume_work_detail[0])) {{!empty($resume->resume_work_detail[0]->section_title)?$resume->resume_work_detail[0]->section_title : 'PROFESSIONAL EXPERIENCE'}}<span class="rename-section text-rename text-primary"> RENAME</span>
                           <span class="titleupdate" style="display:none;"><input type="text" data-link="workdetail" style="width:138px;" value="{{!empty($resume->resume_work_detail[0]->section_title)?$resume->resume_work_detail[0]->section_title : 'PROFESSIONAL EXPERIENCE'}}" ><span class="eduname"><i class="fa fa-check"></i></span> <span class="cancel">Cancel</span></span>@else PROFESSIONAL EXPERIENCE @endif <span class="inner-action" data-resumeId="{{ isset($resume->id)? $resume->id:''}}" data-href="{{route('delete-workdetail')}}"><a href="javascript:;" class="del-section"><i class="fa fa-trash"></i></a> <a href="@if(isset($resume->id)) {{ route('editExprList',['id' => $resume->id]) }} @endif" class="edit-section"><i class="fa fa-pencil"></i></a> <a href="javascript:;" class="btn-icon-tertiary btn-icon-move" style="right: -476px;"><i class="fa fa-arrows-alt" tabindex="0" data-react-beautiful-dnd-drag-handle="1" aria-roledescription="Draggable item. Press space bar to lift" draggable="false"></i></a></span>
                                   </span>
                        </span>
                        <!--<span style="display: inline-inline-block;"> <span><img src="{{asset('templates_images/scvt6/work.png')}}" style="padding-top:2%;" alt=""></span><span style="padding-top: 7px;padding-left: 30px;padding-bottom: 4%;">Work Experience</span> </span><span class="rename-section text-rename"> </span>-->
                     </div>
                     <div class="">
                        <div class="">
                           ...
                           <div id="PARAGRAPH_EXPR_0" class="paragraph PARAGRAPH_EXPR firstparagraph placeholder-text " style="{{$loop->iteration > 1 ?'padding-top:15px;':''}}">
                              <div class="clearfix  doc-item">
                                 <div class="">
                                    <div style="display:inline-block !important" class="paddedline   " dependency="JSTD|EDDT">
                                       <span class="paddedline" dependency="JTIT">
                                          <div style="float: left;width:18%">
                                             <span class="jobdates" id="FIELD_JSTD" format="%Y-%m"><b style="font-size:14px;vertical-align:middle;display: inline-block;">{{ date('Y', strtotime($workhistory->start_date)) }}</b></span>
                                             <!--span dependency="JSTD+EDDT"> - </span>
                                                <span class="jobdates" id="FIELD_EDDT" format="%Y-%m"><b style="font-size:14px">{{ $workhistory->is_current == '1' ? 'Current' : date('Y', strtotime($workhistory->end_date)) }}</b></span-->
                                             <span style="border-left: 2px solid #000;border-right: 2px solid #000;display: inline-block;padding: 8px 2px;margin-left: 2px;height:{{ isset($pdf_view)?'17px;':'22px;'}};vertical-align:middle;"></span>
                                          </div>
                                          <div style="display: inline-block;width:57%;padding-left:{{ isset($pdf_view)?'11%;':'1%'}};vertical-align:middle">
                                             <span class="jobtitle txtBold" id="FIELD_JTIT" style="position: relative;top: -5px;">{{  $workhistory->job_title  }}</span>
                                             <br>
                                             <span class=" locationGap txtItl" dependency="COMP|JSTA|JCIT" style="position: relative;top: -6px;">
                                          ...
                                          <div style="display: inline;float: right;width:19%;{{ isset($pdf_view)?'margin-top:5px;':''}}"><span class="companyname" id="FIELD_COMP">{{  $workhistory->employer  }}</span></div>
                                       </span>
         ...
         <div class="sortable-item section-container SortableItem-sibling  data-SEC" style="clear:both;padding-top:16px">
            <div id="SECTION_EDUC411a31aa-7167-4080-837f-be30a3388e31" class="section education SECTION_EDUC  noparagraph multi-para" data-section-cd="SEC">
               <div class="editcontent doc-item">
                  <div class="heading" style="border-top: 2px solid #E3e3e3;">
                     <div class="sectiontitle" id="SECTIONNAME_SEC" style='font-size:16px;color:{{isset($resume->color)? $resume->color:"#002e58"}}' > @if(isset($resume->extraSection->title)) {{$resume->extraSection->title}} <span class="rename-section text-rename text-primary">Rename</span>
                        <span class="titleupdate" style="display:none;"><input type="text" data-link="extrasection" value="{{$resume->extraSection->title}}" ><span class="eduname"><i class="fa fa-check"></i></span> <span class="cancel">Cancel</span></span>@else  @endif<span class="inner-action" data-resumeId="{{ isset($resume->id)? $resume->id:''}}" data-href="{{route('deletsection')}}"><a href="javascript:;" class="del-section"><i class="fa fa-trash"></i></a> <a href="@if(isset($resume->id))  {{ route('edit-section',['id' => $resume->id]) }} @endif" class="edit-section"><i class="fa fa-pencil"></i></a> <a href="javascript:;" class="btn-icon-tertiary btn-icon-move" style="right: -476px;"><i class="fa fa-arrows-alt" tabindex="0" data-react-beautiful-dnd-drag-handle="1" aria-roledescription="Draggable item. Press space bar to lift" draggable="false"></i></a></span>
                     </div>
                  </div>
                  <div class="">
