...
<html><head skincd="SRZ7"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <default name="SDCL" content="#252932">
    ...
    <formula name="CIMT" content="({$LNSP} * 2) + 5">
    <formula name="SHMB" content="{$LNSP} + 5">
    <formula name="TDMT" content="{$PSPC} div 2">
    <formula name="RTNG" content="{$PSPC} - 5">
    <formula name="HDLH" content="{$HDSZ} + {$LNSP}">
    <formula name="JTTL" content="{$FTSZ} + 3">
    <formula name="SCSP" content="{$SSPC} + 5">
    <formula name="SCML" content="{$PIND} + 100">
    <formula name="DTWD" content="{$PIND} + 90"><!--Dates wrapper width-->
    ...
    <style type="text/css" id="static">
        ...
        #document.skn-srz7 ol,#document.skn-srz7 ul{list-style:none}
        #document.skn-srz7 table{border-collapse:collapse;border-spacing:0;font-size:inherit;color:inherit;width:100%}

        /*START content disc style for LI*/
        #document.skn-srz7 ul,#document.skn-srz7 li{margin:0;padding:0;list-style-type:disc}
        #document.skn-srz7 ul li{margin:0 0 0 16px;padding:0}
        @-moz-document url-prefix() {#document.skn-srz7 ul li{margin:0 0 0 12px;padding:0 0 0 3px}}
        /*END content disc style for LI*/

        #document.skn-srz7{box-sizing:border-box}
        #document.skn-srz7 .name{color:#252932;font-size:15px;line-height:17px;font-weight:bold;padding:0;text-align:left}
        #document.skn-srz7 .paragraph{position:relative;clear:both}
        #document.skn-srz7 .heading{clear:both;font-weight:bold;color:#252932;border-bottom:1px solid #CCC}
        #document.skn-srz7 .sectiontitle{color:#252932;word-wrap:break-word;vertical-align:middle;display:inline}
        #document.skn-srz7 .address{position:relative;text-align:left;font-size:0.917em;line-height:1.25em;margin-top:0}
        #document.skn-srz7 .table_wrapper{width:100%;margin-top:0}
        #document.skn-srz7 table.twocol td{width:50%}
        #document.skn-srz7 table.skills{width:100%}
        #document.skn-srz7 table.skills th,#document.skn-srz7 table.skills td{width:20%;text-align:center}
        #document.skn-srz7 table.skills th{text-decoration:underline}
        #document.skn-srz7 table.skills .skillname,#document.skn-srz7 table.skills .skillrating{text-align:left;width:35%}
        #document.skn-srz7 table.skills .skillrating{width:20%}
        #document.skn-srz7 table.skills .skillyears,#document.skn-srz7 table.skills .skilllast{width:19%}
        #document.skn-srz7 table.skills .pad1{width:5%}
        #document.skn-srz7 table.skills .pad2,#document.skn-srz7 table.skills .pad3{width:1%}
        #document.skn-srz7 .mb5{margin-bottom:5px}
        #document.skn-srz7 .resumeTitle{text-align:left;color:#252932;font-weight:500}
        #document.skn-srz7 td.twocol_2{border-left:1px  solid #FEFDFD}
        #document.skn-srz7 .addressright, #document.skn-srz7 .addressleft{display:table-cell; width:40%}

        #document.skn-srz7 span.paddedline{display:block}
        #document.skn-srz7 .txtRight{text-align:right;clear:both}
        #document.skn-srz7 span.jobtitle,#document.skn-srz7 span.degree,#document.skn-srz7 span.programline{font-weight:bold}
        #document.skn-srz7 span.dates_wrapper{font-weight:bold;display:block;float:left;text-align:left;padding-right:10px}
        #document.skn-srz7 .txtItalics{font-style:italic}

        /*Icons*/
        #document.skn-srz7 .iconRow{clear:both;padding-bottom:7px;word-wrap:break-word}
        #document.skn-srz7 .iconRow .iconSvg{width:20px;height:20px;float:left;margin-right:5px}
        #document.skn-srz7 .iconRow .icoTxt{margin-left:25px}

        #document.skn-srz7 .headingIcon{display:inline-block;vertical-align:middle;margin-right:5px}
        #document.skn-srz7 .headingIcon svg{height:30px;width:30px;display:block}

        #document.skn-srz7 .iconRow svg rect,#document.skn-srz7 .headingIcon svg rect{fill:#252932}
        #document.skn-srz7 .iconRow svg path,#document.skn-srz7 .headingIcon svg path{fill:#fff}

        #document.skn-srz7 .ratingWrapper{float:right;text-align:right;height:10px;padding:3px 0}
        #document.skn-srz7 .rtngSec .txtRight{position:relative;top:-3px}
        #document.skn-srz7 .ratingWrapper svg{height:13px}
        #document.skn-srz7 .ratingWrapper .default-fill{fill:#252932}
    </style>
    <style type="text/css" id="dynamic" leftcolwidth="0">
        #document.skn-srz7,#document.skn-srz7 table{line-height:{$FTLH}px}
        #document.skn-srz7.pagesize{width:{$PGSZ}px}
        #document.skn-srz7.fontsize{font-size:{$FTSZ}px}
        #document.skn-srz7.fontface{font-family:{$FTFC}}
        #document.skn-srz7.vmargins{padding-top:{$TBMR}px;padding-bottom:{$TBMR}px}
        #document.skn-srz7.hmargins{padding-left:{$LRMR}px;padding-right:{$LRMR}px}
        #document.skn-srz7 .section{padding-top:{$SCSP}px}
        #document.skn-srz7 .address{font-size:{$CISZ}px;line-height:{$CILH}px;padding-top:{$CIMT}px}
        #document.skn-srz7 .heading{margin-bottom:{$SHMB}px}
        #document.skn-srz7 .jobtitle,span.degree,span.programline{font-size:{$JTTL}px}
        #document.skn-srz7 .paragraph{padding-top:{$PSPC}px}
        #document.skn-srz7 .rtngSec .paragraph{padding-top:{$RTNG}px}
        #document.skn-srz7 .firstsection,#document.skn-srz7 .firstparagraph,#document.skn-srz7 .SECTION_CNTC{padding-top:0!important}
        #document.skn-srz7 .singlecolumn,#document.skn-srz7 .maincolumn{margin-left:{$SCML}px}
        #document.skn-srz7 .sectiontitle,#document.skn-srz7 .resumeTitle{font-size:{$HDSZ}px;line-height:{$HDLH}px}
        #document.skn-srz7 .name{font-size:{$NMSZ}px;line-height:{$NMLH}px}
        #document.skn-srz7 table.skills td{padding-top:{$TDMT}px}
        #document.skn-srz7 .noPind{margin-left:0}
        #document.skn-srz7 .name,#document.skn-srz7 .sectiontitle,#document.skn-srz7 .resumeTitle{color:{$SDCL}}
        #document.skn-srz7  span.dates_wrapper{width:{$DTWD}px;font-size:{$DTSZ}px;line-height:{$DTLH}px}

        /* Icon */
        #document.skn-srz7 .iconRow svg rect,#document.skn-srz7 .headingIcon svg rect{fill:{$SDCL}}
        #document.skn-srz7 .ratingfield p{display:inline}

        /*Phase 2: fixes for builder page*/
        #document.skn-srz7 .sortable-item .sectiontitle,body.SRZ7 .parent-drag.active#document.skn-srz7 .sectiontitle{display:inline}
        #document.skn-srz7 .sortableInner .sortable-item.active .wrapper-bg + div,
        body.SRZ7 #document.skn-srz7  ._single-parent-drag.active#document.skn-srz7 .wrapper-bg + div{position:relative;z-index:11}
        #document.skn-srz7 .sortable-item .singlecolumn span:first-child,
        body.SRZ7 ._single-parent-drag.active#document.skn-srz7 .singlecolumn span:first-child{display:inline-block}
        #document.skn-srz7 .ratingWrapper .default-fill{fill:{$SDCL}}
    </style>

    <title>Z Skin | Iconic</title>


    <div id="document" class="skn-srz7 fontsize fontface vmargins hmargins pagesize">
        <div id="SECTION_NAME" class="section notdraggable">
            <div id="PARAGRAPH_NAME" class="paragraph PARAGRAPH_NAME">
                <div class="name">
                    <span class="field" id="FIELD_FNAM">Andrew G.</span><span dependency="FNAM+LNAM"> </span><span class="field" id="FIELD_LNAM">Hunter</span>
                </div>
                    ...
                    <div class="addressleft">
                        <div class="iconRow" dependency="STRT|CITY|STAT|ZIPC">
                            <div class="iconSvg">
                                <svg viewBox="0 0 42 42">
                                    ...
                                    <path transform="translate(5,5)" d="M16 0C8.772 0 2.912 5.86 2.912 13.088 2.912 20.428 9.276 25.27 16 32c6.724-6.732 13.088-11.572 13.088-18.912C29.088 5.86 23.228 0 16 0zm0 22.288c-5.302 0-9.602-4.298-9.602-9.602 0-5.302 4.298-9.602 9.602-9.602 5.302 0 9.602 4.298 9.602 9.602s-4.3 9.602-9.602 9.602z"></path>
                                </svg>
                            </div>
                            <div class="icoTxt">
                        ...
                        <div class="iconRow" dependency="EMAI">
                            <div class="iconSvg">
                                <svg viewBox="0 0 42 42">
                                    <rect x="0" y="0" height="42" width="42"></rect>
                                    <path transform="translate(5,5)" d="M32 6c0-1.106-.894-2-2-2H2C.894 4 0 4.894 0 6l16 13L32 6z"></path>
                                    <path transform="translate(5,5)" d="M0 9v17c0 1.106.894 2 2 2h28c1.106 0 2-.894 2-2V8.968L16 22 0 9z"></path>
                                </svg>
                            </div>
                            <div class="icoTxt">
        ...
        <div id="SECTION_SUMM" class="section notdraggable">
        ...
        <div id="SECTION_HILT" class="section rtngSec">
            <div class="heading">
                ...
                <span class="sectiontitle" id="SECTIONNAME_HILT">Highlights</span>
            </div>
            <div class="paragraph" id="PARAGRAPH_HILT">
                <div class="singlecolumn maincolumn">
                    <span class="ratingfield" id="FIELD_SKC1"></span>
                    <span class="ratingWrapper" dependency="RATV">
                        <svg viewBox="0 0 500 100" id="FIELD_RATV" type="count">
                            <rect x="25" y="0" height="75" width="75" fill="#d5d6d6"></rect>
                            <rect x="125" y="0" height="75" width="75" fill="#d5d6d6"></rect>
                            <rect x="225" y="0" height="75" width="75" fill="#d5d6d6"></rect>
                            <rect x="325" y="0" height="75" width="75" fill="#d5d6d6"></rect>
                            <rect x="425" y="0" height="75" width="75" fill="#d5d6d6"></rect>
                        </svg>
                    </span>
        ...
        <div id="SECTION_EXPR" class="section">
            <div class="heading">
                ...
                <span class="sectiontitle" id="SECTIONNAME_EXPR">Experience</span>
            </div>
            <div class="paragraph" id="PARAGRAPH_EXPR">
                <span class="dates_wrapper" dependency="JSTD|EDDT">
                    <span class="jobdates" id="FIELD_JSTD" format="%Y-%m">3/2007</span>
                    <span dependency="JSTD+EDDT"> - </span>
                    <span class="jobdates" id="FIELD_EDDT" format="%Y-%m">8/2007</span>
                </span>
        ...
        <div id="SECTION_EDUC" class="section">
            <div class="heading">
                ...
                <span class="sectiontitle" id="SECTIONNAME_EDUC">Education</span>
            </div>
            <div class="paragraph" id="PARAGRAPH_EDUC">
                <span class="dates_wrapper" dependency="GRST">
                    <span class="jobdates" id="FIELD_GRST" format="%Y-%m">2007</span>
                    <span dependency="GRST+GRED"> - </span>
                    <span class="jobdates" id="FIELD_GRED" format="%Y-%m">8/2007</span>
                </span>
                <div class="singlecolumn">
        ...
        <div id="SECTION_ADDI" class="section">
            <div class="heading">
                <span class="headingIcon">
                    <svg viewBox="0 0 42 42">
                        <rect x="0" y="0" height="42" width="42"></rect>
                        <path transform="translate(5,5)" d="M32 11.595c-.229-.455-.457-.682-.914-.682H20.343L16.914.683C16.914.226 16.457 0 16 0s-.914.227-.914.682l-3.429 10.231H.914c-.228 0-.685.227-.914.682 0 .455 0 .91.457 1.137l8.457 6.593L5.03 30.693c-.229.454 0 .91.457 1.136.457.228.914.228 1.143 0L16 25.01l9.371 6.593c.229.227.458.227.686.227.229 0 .457 0 .686-.227.457-.227.457-.682.457-1.137l-3.886-11.367 8.457-6.594c.229 0 .229-.454.229-.909zM3.886 12.959h7.085L9.6 17.28l-5.714-4.32zM24 28.192l-7.543-5.23c-.228-.227-.457-.227-.686-.227-.228 0-.457 0-.685.228L8 28.192l8-24.1 8 24.1zm-1.6-10.913l-1.371-4.32h7.085L22.4 17.28z"></path>
                    </svg>
                </span>
                <span class="sectiontitle" id="SECTIONNAME_ADDI">Additional Information</span>
            </div>
        ...
        <div id="SECTION_CUST" class="section">
            <div class="heading">
                ...
                <span class="sectiontitle" id="SECTIONNAME_CUST">Negotiated</span>
            </div>
        ...
        <div id="SECTION_SFTR" class="section rtngSec">
            <div class="heading">
                <span class="headingIcon">
                    <svg viewBox="0 0 42 42">
                        <rect x="0" y="0" height="42" width="42"></rect>
                        <path transform="translate(5,5)" d="M30.08 2.986H1.92C.853 2.986 0 3.84 0 4.906v17.067c0 1.067.853 1.92 1.92 1.92h13.013v2.987h-4.906c-.64 0-1.067.426-1.067 1.066 0 .64.427 1.067 1.067 1.067h11.946c.64 0 1.067-.427 1.067-1.067 0-.64-.427-1.066-1.067-1.066h-4.906v-2.987H30.08c1.067 0 1.92-.853 1.92-1.92V4.906c0-1.066-.853-1.92-1.92-1.92zm0 18.987H1.92V4.906h27.947v17.067z"></path>
                    </svg>
                </span>
                <span class="sectiontitle" id="SECTIONNAME_SFTR">Software</span>
            </div>
...
</formula></formula></formula></formula></formula></formula></formula></formula></formula></formula></formula></formula></formula></formula></formula></formula></formula></formula></formula></default></default></default></default></default></default></default></default></default></default></default></default></body></html>