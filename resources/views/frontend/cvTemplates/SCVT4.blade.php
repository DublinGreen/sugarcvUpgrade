   ...
   <div class="">
      <div>
         <style type="text/css" id="static">
            ...
            #document.skn-trz7 .resumeTitle{color:#002e58;font-weight:400}
            /* Heading */
            #document.skn-trz7 .heading{border-bottom:1px solid #000;padding:0 0 3px;letter-spacing:0;font-weight:bold;line-height:15px;margin-bottom:10px}
            #document.skn-trz7 .sectiontitle{color:#002e58;word-wrap:break-word;text-transform: uppercase;}
            ...
            #document.skn-trz7 .left-box,#document.skn-trz7 .right-box{padding-left:0px}
            #document.skn-trz7 .left-box{padding-left:0;padding-right:0px}
            #document.skn-trz7 .left-box{box-sizing:border-box;display:inline-block;letter-spacing:0.2px}
            #document.skn-trz7 .right-box .section:first-child,#document.skn-trz7 .left-box .section:first-child{padding-top:0px!important}
            #document.skn-trz7 .right-box .paddedline.date-content{position:relative;font-weight:700;margin-left:0;width:100%}
            #document.skn-trz7 .paragraph{position:relative}
            #document.skn-trz7 .summary .singlecolumn{margin-left:0}
            #document.skn-trz7 .right-box{display:inline-block;width:60%;letter-spacing:0.2px;float:right!important;}
            #document.skn-trz7 .summary.section{padding-top:30px}
           ...
           /* #document.skn-trz7 .paragraph.datespara:after{content:'';display:table;clear:both} */
			#document.skn-trz7 .topsection .left-box {float: left;padding-bottom: 0;padding-left: 0;padding-right: 0;width: 43%;}
			#document.skn-trz7 .topsection .right-box {padding-bottom: 0;padding-left: 0;width: 57%;text-align:left;}
			...
			#document .parentContainer .left-side{float:left;}
			...
			#document.skn-trz7 .main{font-size:16px;color:#002e58;line-height:16px; padding-top:25px;color:#fff}
			 #document.skn-trz7 .sectiontitle-li{font-size:16px;color:#FF0000}
			 @media screen and (min-height: 768px) and (min-width: 1920px){ #document.skn-trz7 .right-box{width:65%!important} #openImageUploader{padding-left:84px !important} #righttopimg{width:116%!important} }
			 #righttopimg{width: 138%;
    height: 110px;
    padding-top: 0px;
    padding-bottom: 0px;
    margin-left: -100px;
    ...
    display: none;
         ...
         <style type="text/css" id="dynamic" data-time="Tue May 26 2020 17:35:58 GMT+0530 (India Standard Time)">
            ...
            #document.skn-trz7.hmargins{padding-left:0px;padding-right:0px}
            ...
            #document.skn-trz7 .jobtitle, #document.skn-trz7 .degree, #document.skn-trz7 .programline{font-size:14px;font-weight:bold}


            #document.skn-trz7 .heading{line-height:22px}


            #document.skn-trz7 .left-box{width:39%;}
            #document.skn-trz7 .right-box .paragraph .singlecolumn{margin-left:0px}
            #document.skn-trz7 svg{stroke:#002e58}
            #document.skn-trz7 .resumeTitle{font-size:16px;color:#002e58;line-height:16px}
			...
			#document .topsection .headimg{background:red; width: 100%; padding-left:0px !important; padding-right:0px !important; margin-top:30px}
			#document .parentContainer .left-side{background-color:#d9d9d9;}
			#document .parentContainer .right-side{padding-right:40px}
			ul.ba {    list-style-type: none;}
			#document.skn-trz7 .main{font-size:16px;color:#002e58;line-height:16px; padding-top:25px;color:#fff}
			 #document.skn-trz7 .sectiontitle-li{font-size:16px;color:#FF0000}
			 div#CONTAINER_PARENT_1 .left-box {margin-top: 4px;}
			 ...
			 .row.about-container .resume-preview.thumb-preview.resume-animation #document.skn-trz7 .parentContainer .right-side {width: 360px!important;}
			 .row.about-container .resume-preview.thumb-preview.resume-animation #document.skn-trz7 .parentContainer .right-side .tmargin {top: 110px!important;}
			 .row.about-container .resume-preview.thumb-preview.resume-animation #document.skn-trz7 .topsection {width: 611px!important;}

			 .row.about-container .resume-preview.thumb-preview.resume-animation #document , .page-finalize #document {height: 100%!important;}

			 .row.about-container .resume-preview.thumb-preview.resume-animation #document .parentContainer .left-side, .page-finalize #document .parentContainer .left-side {width: 42%;}
			 ...
			 .row.about-container .resume-preview.thumb-preview.resume-animation #document.skn-trz7 .parentContainer .right-side #sizere {font-size:33px !important}
			 span#FIELD_STRT:after { content: ',';}

			 @media (min-width:1024px){
				#document .parentContainer .right-side {
					padding-right: 0px;
				}
			 }
			 ...
			 @if(isset($pdf_view))
				#CONTAINER_PARENT_1 #CONTAINER_1{ }
				#openImageUploader{padding-left: 45px!important;}
				.IMGSOC{}
				.SOILI{padding: 8px 0 0 0 !important;}
           
			 @else
				li.SOILI {display: flex;}
				#openImageUploader{ padding-left: 25px !important;}
				#righttopimg{margin-left: -134px;}
            .SOILI span{
            margin: auto 0;
			 }
			 @endif
	  ...
	  <!---------header---------------->
      <div id="document" class="document fontsize fontface vmargins hmargins pagesize skn-trz7 TRZ7  ZTY" style='font-family:{{isset($resume->fontFamily)? $resume->fontFamily:"Century Gothic"}};line-height:{{isset($resume->lineSpacing)? $resume->lineSpacing:"18px"}};font-size:{{isset($resume->fontSize)? $resume->fontSize:"11px"}};width:100%;height:1020px;margin-top:5px;background:#d9d9d9;padding-bottom:10px;overflow: hidden;'>
         ...
         <div id="CONTAINER_PARENT_1" class="parentContainer" style="width:100%;clear:both;">
            <div id="CONTAINER_1" class="left-box left-side " style="width:{{isset($pdf_view)?'226px':'32%'}};position: relative;z-index: 1;">
			 <img class="IMGSOC" src="{{asset('templates_images/scvt4/lefttop.jpeg')}}" alt="Snow" style="width:100%;margin-top:27px;margin-bottom:100px;">
		  <div style="position: absolute;top: 14px;left: 10px;">
		 <div style="padding-left: 26px;margin-left: 0px;margin-top:0px;cursor:pointer;float:left;margin-top:-8px" id="openImageUploader" title="Change Image">
									@if(isset($resume->image))
									<img src="{{ url('images/resumeImages/') }}/{{ $resume->image }}" / style="width:184px;height:180px">
									@else
									<img src="{{ url('asset_new/img/user/profile.png')}}" style="width:184px;height:180px"/>
									@endif
                                 </div>
								 </div>
			 <!--div data-react-beautiful-dnd-draggable="0" class="sortable-item section-container SortableItem-sibling  data-NAME">
                  ...
                  <div id="SECTION_NAME464b9aab-d77c-4f2a-994a-4f79aa785951" class="section notdraggable SECTION_NAME firstsection  " data-section-cd="NAME">
                     <div class=" doc-item editcontent">
                        <div class="">
                           <div class="">
                              <div id="PARAGRAPH_NAME_f7eda8ec-b653-4afd-af6e-42abfa260097" class="paragraph PARAGRAPH_NAME firstparagraph  ">
                                 <div>
                                    <div class="name word-break">
                                       <span class="field" id="FIELD_FNAM">First </span>
                                       <span class="field word-break" id="FIELD_LNAM">Last </span>
                                    </div>
               ...
               <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-CNTC">
                  <div class="document-tool sec-tool" id="editIcons" style="right: -22px;"></div>
                  <div id="SECTION_CNTC4b959b3f-7a77-4285-9b17-82823b7d38a8" class="section SECTION_CNTC notdraggable" data-section-cd="CNTC" style="padding-top:34px">
                     <div class=" doc-item editcontent" style="padding-left:15px;" dhref="@if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif">
                        <!--div class="heading">
                           <div class="sectiontitle" id="SECTIONNAME_CNTC" style='font-size:16px;color:{{isset($resume->color)? $resume->color:"#002e58"}}'>Contact<span class="rename-section text-rename"> </span></div>
                        </div-->
                        <div class="">
                           <div class="">
                                 ...
                                 <div class=" doc-item" style="">
                                    <div class="address">
									   ...
									   <!--div dependency="STRT|CITY|STAT|ZIPC">
									   		<span class="fa-stack fa-lg sectiontitle-li" style="width: 16%;display: inline;">
										  ...
										  <span class="fa-stack fa-lg sectiontitle-li" style="display: inline;">
											...
											<ul>
												<li class="SOILI" style="list-style: none;border: 1px solid;padding: 0px 0 0 0;margin: 0;border-right: none;">
													  @if(isset($pdf_view))
                          <div style="float:left;margin-right:5px;"><img class="IMGSOC" src="{{ url('images/shapeImages/location2.png')}}" style="margin-top: 0;width: 32px;margin-right: 5px;">
                          </div><div class="address" style="margin-left:40px;margin-bottom:5px;">

                   @else
                   <div ><img class="IMGSOC" src="{{ url('images/shapeImages/location2.png')}}" style="margin-top: 0;width: 32px;margin-right: 5px;">
                      ...
                      @endif
                                    ...
                                    <img class="IMGSOC" src="{{ url('images/shapeImages/phone2.png')}}" style="display: inline-block;vertical-align: middle;margin-top: 0;width: 32px;margin-right: 5px;">
												...
												<li class="SOILI" style="list-style: none;border: 1px solid;padding: 0px 0 0 0;margin: 0;border-right: none;border-top: none">
													<img class="IMGSOC" src="{{ url('images/shapeImages/linkdin.png')}}" style="display: inline-block;vertical-align: middle;margin-top: 0;width: 32px;margin-right: 5px;">
													<span class="field" id="FIELD_LINKDIN" style="display: inline-block;vertical-align: middle;width:80%;"> {{ $resume->linkedin}} </span>
												</li>
												 @endif
												@if(!empty($resume->facebook))
												<li class="SOILI" style="list-style: none;border: 1px solid;padding: 0px 0 0 0;margin: 0;border-right: none;border-top: none">
													<img class="IMGSOC" src="{{ url('images/shapeImages/facebook.png')}}" style="display: inline-block;vertical-align: middle;margin-top: 0;width: 32px;margin-right: 5px;">
													<span class="field" id="FIELD_FACEBOOK" style="display: inline-block;vertical-align: middle;width:80%;"> {{ $resume->facebook}} </span>
												</li>
												 @endif
												@if(!empty($resume->website))
												<li class="SOILI" style="list-style: none;border: 1px solid;padding: 0px 0 0 0;margin: 0;border-right: none;border-top: none">
													<img class="IMGSOC" src="{{ url('images/shapeImages/website.png')}}" style="display: inline-block;vertical-align: middle;margin-top: 0;width: 32px;margin-right: 5px;">
													<span class="field" id="FIELD_WEBSITE" style="display: inline-block;vertical-align: middle;width:80%;"> {{ $resume->website}} </span>
												</li>
                                       @endif
												@if(!empty($resume->twitter))
												<li class="SOILI" style="list-style: none;border: 1px solid;padding: 0px 0 0 0;margin: 0;border-right: none;border-top: none">
													<img class="IMGSOC" src="{{ url('images/shapeImages/twitter.png')}}" style="display: inline-block;vertical-align: middle;margin-top: 0;width: 32px;margin-right: 5px;">
													<span class="field" id="FIELD_EMAI" style="display: inline-block;vertical-align: middle;width:80%;"> {{ $resume->twitter}} </span>
												</li>
												@endif
											</ul>
               ...
               <div  class="sortableInner">
			     <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-EDUC">
                  ...
                  <div id="SECTION_EDUCe38830c3-809a-48c9-a15b-57e04eb83e0e" class="section education SECTION_EDUC  noparagraph multi-para" data-section-cd="EDUC">
                     <div class=" doc-item editcontent" style="padding-left:15px" dhref="@if(isset($resume->id))  {{ route('editEducationList',['id' => $resume->id]) }} @endif">
                        <div class="heading" style="padding-top: 4px;">
                           <div class="sectiontitle" id="SECTIONNAME_EDUC" style='font-size:16px;color:{{isset($resume->color)? $resume->color:"#002e58"}}'>@if(isset($resume->resume_education_detail[0])) {{!empty($resume->resume_education_detail[0]->section_title)?$resume->resume_education_detail[0]->section_title : 'EDUCATION'}}<span class="rename-section text-rename text-primary"> RENAME</span>
								...
								<div class=" doc-item">
								   <div class="singlecolumn">
									  <div class="paddedline date-content">
									   <span class="degree" id="FIELD_DGRE">{{ $education->degree }}</span><br>
									   <span class="companyname" id="FIELD_SCHO">{{ $education->school_name }}&nbsp;/&nbsp;{{ $education->school_location }}</span><br>
						  ...
						  @else
							 <div id="PARAGRAPH_EDUC_0" class="paragraph datespara PARAGRAPH_EDUC firstparagraph placeholder-text ">
								<div class=" doc-item">
								   <div class="singlecolumn">
									  <div class="paddedline date-content">
                             <span class="degree" id="FIELD_DGRE">Bachelor of Arts</span><br>
                             <span class="companyname" id="FIELD_SCHO">School Name, School Location</span>
               ...
               <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-HILT">
                  ...
                  <div id="SECTION_HILT78287197-6649-4595-8d7a-51b01fd1ff77" class="section SECTION_HILT  noparagraph " data-section-cd="HILT">
                     <div class=" doc-item editcontent" style="padding-left:15px" dhref="@if(isset($resume->id))  {{ route('edit-skills',['id' => $resume->id]) }} @endif">
                        <div class="heading">
                           <div class="sectiontitle" id="SECTIONNAME_HILT" style='font-size:16px;color:{{isset($resume->color)? $resume->color:"#002e58"}}'>@if(isset($resume->skills)) {{!empty($resume->skills->section_title)?$resume->skills->section_title : 'SKILLS'}} <span class="rename-section text-rename text-primary" > RENAME </span>
			   ...
			   @endif
			    <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-BIOD">
                  ...
                  <div id="SECTION_HILT1d994807-ac0c-4d3a-9c88-9a205c80f50c" class="section SECTION_HILT  noparagraph " data-section-cd="BIOD">
                     <div class="editcontent doc-item" style="padding-left:15px" dhref="@if(isset($resume->id))  {{ route('edit-resume',['id' => $resume->id]) }} @endif">
                        <div class="heading">
                           <div class="sectiontitle" id="SECTIONNAME_BIOD" style='font-size:16px;color:{{isset($resume->color)? $resume->color:"#002e58"}}'>{{!empty($resume->bio_section_title)?$resume->bio_section_title:'BIO'}}<span class="rename-section text-rename text-primary"> RENAME</span>
                                    ...
                                    <div class="biodata">
                                       <div class="singlecolumn">
										  <div dependency="DOB">
                                             ...
                                             <span class="field" id="FIELD_DOB">{{ !empty($resume->dob)? $resume->dob:date('d-m-Y') }}</span>
											 </div>
                                          </div>
            ...
            <div id="CONTAINER_2" class="right-box right-side" style="background:#fff;padding-bottom:20px">
			<div class=" editcontent" dhref="@if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif" style="width:105% !important;padding-left:0% !important;margin-top:0px;margin-left:-6px;position:relative;background: #ffffff;">
			...
			<div class="sortableInner" style="margin-top:{{isset($pdf_view)?'20px':'0'}};">
			<div data-react-beautiful-dnd-draggable="0" class="sortable-item section-container SortableItem-sibling  data-SUMM">
                  ...
                  <div id="SECTION_SUMM879edb71-bdad-4ac5-a858-3bcc1c38ab71" class="section summary notdraggable SECTION_SUMM  noparagraph " data-section-cd="SUMM">
                     <div class="editcontent doc-item" style="padding-left:15px" dhref="@if(isset($resume->id)) {{ route('edit-summary',['id' => $resume->id]) }} @endif">
                        <div class="">
                           <div class="">
                              <div id="PARAGRAPH_SUMM_0" class="paragraph PARAGRAPH_SUMM firstparagraph placeholder-text ">

                                 <div class=" doc-item" style="">
								 <div class="heading" style="border-top: 1px solid #000;padding-top: 4px;">
								   <div class="sectiontitle" id="" style='font-size:16px;color:{{isset($resume->color)? $resume->color:"#002e58"}}'>@if(isset($resume->summary)) {{!empty($resume->summary->section_title)?$resume->summary->section_title : 'PROFILE'}}<span class="rename-section text-rename text-primary"> RENAME</span>
               ...
               <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-EXPR">
                  ...
                  <div id="SECTION_EXPR06fafd67-c5ae-45e8-b4a1-ed0f75d06194" class="section experience SECTION_EXPR  noparagraph multi-para" data-section-cd="EXPR">
                     <div class="editcontent doc-item" style="padding-left:15px" dhref="@if(isset($resume->id)) {{ route('editExprList',['id' => $resume->id]) }} @endif">
                        <div class="heading" style="border-top: 1px solid #000;padding-top: 4px;">
                           <div class="sectiontitle" id="SECTIONNAME_EXPR" style='font-size:16px;color:{{isset($resume->color)? $resume->color:"#002e58"}}'>@if(isset($resume->resume_work_detail[0])) {{!empty($resume->resume_work_detail[0]->section_title)?$resume->resume_work_detail[0]->section_title : 'WORK EXPERIENCE'}}<span class="rename-section text-rename text-primary"> RENAME</span>
                                  <span class="titleupdate" style="display:none;"><input type="text" data-link="workdetail" value="{{!empty($resume->resume_work_detail[0]->section_title)?$resume->resume_work_detail[0]->section_title : 'WORK EXPERIENCE'}}" ><span class="eduname"><i class="fa fa-check"></i></span> <span class="cancel">Cancel</span></span>@else PROFESSIONAL EXPERIENCE @endif <span class="inner-action" data-resumeId="{{ isset($resume->id)? $resume->id:''}}" data-href="{{route('delete-workdetail')}}"><a href="javascript:;" class="del-section"><i class="fa fa-trash"></i></a> <a href="@if(isset($resume->id)) {{ route('editExprList',['id' => $resume->id]) }} @endif" class="edit-section"><i class="fa fa-pencil"></i></a> <a href="javascript:;" class="btn-icon-tertiary btn-icon-move" style="right: -476px;"><i class="fa fa-arrows-alt" tabindex="0" data-react-beautiful-dnd-drag-handle="1" aria-roledescription="Draggable item. Press space bar to lift" draggable="false"></i></a></span></div></div>
                        <div class="">
                           <div class="sortableInner">
						  @if(isset($resume->resume_work_detail) && $resume->resume_work_detail)
							@php $x=0; @endphp
							@foreach($resume->resume_work_detail as $workhistory)
                              <div id="PARAGRAPH_EXPR_0" class="paragraph PARAGRAPH_EXPR firstparagraph placeholder-text" style="{{ $x!=0 ? 'margin-top: 15px !important;' : $x=1 }}">
                                 <div class=" doc-item" style="">
                                    <div class="singlecolumn">
									<!--div class="paddedline date-content" dependency="JSTD|EDDT">
									   ...
									   <span class="jobtitle txtBold" id="FIELD_JTIT">{{  $workhistory->employer  }}&nbsp;/&nbsp;{{  $workhistory->state  }}, {{  $workhistory->country  }}&nbsp;/&nbsp;{{ date('M, Y', strtotime($workhistory->start_date)) }}-{{ $workhistory->is_current == '1' ? 'Current' : date('M, Y', strtotime($workhistory->end_date)) }}</span>
						  ...
						  @else
                              ...
                              <div id="PARAGRAPH_EXPR_-2" class="paragraph PARAGRAPH_EXPR placeholder-text ">
                                 <div class=" doc-item" style="padding-left:15px">
                                    <div class="singlecolumn">
			  ...
			  <div class="sortable-item section-container SortableItem-sibling  data-SEC">
				 <div id="SECTION_EDUC411a31aa-7167-4080-837f-be30a3388e31" class="section education SECTION_EDUC  noparagraph multi-para" data-section-cd="SEC">
					<div class="editcontent doc-item" style="padding-top:20px;padding-left:15px" dhref="@if(isset($resume->id))  {{ route('edit-section',['id' => $resume->id]) }} @endif">
					   <div class="heading" style="border-top: 1px solid #000;padding-top: 4px;">
