   ...
   <div class="">
      <div>
         <style type="text/css" id="static">
            ...
            #document.skn-trz9 .resumeTitle{color:#f5c814;font-weight:400}
            /* Heading */
            #document.skn-trz9 .heading{padding:0 0 3px;letter-spacing:0;font-weight:bold;line-height:15px;margin-top:10px}
            ...
            #document.skn-trz9 .left-box .paddedline.date-content{position:absolute;margin-left:64%;padding-top:15px;width:36%}
			#document.skn-srz1 .left-box .paddedline.date-content{left:260px}
            #document.skn-trz9 .paragraph{position:relative}
            #document.skn-trz9 .summary .singlecolumn li{}
            #document.skn-trz9 .right-box{float:right;letter-spacing:0.2px; background-color:#fff;color:#000}
			 #document.skn-trz9 .parentContainer .right-box{float:left}
            #document.skn-trz9 .summary.section{}
			...
			#document.skn-trz9 .topsection .left-box {float: left;padding-left: 0;padding-right: 0;background: #dc3545;height:237px;}
			#document.skn-trz9 .topsection .right-box {padding-bottom: 0;padding-left: 0;width: 40%;text-align: left;position: relative;right:0px;}
         ...
         <style type="text/css" id="dynamic" data-time="Tue May 26 2020 17:35:58 GMT+0530 (India Standard Time)">
            ...
            #document.skn-trz9 .section{padding-top:10px}
            ...
            #document.skn-trz9 .jobtitle, #document.skn-trz9 .degree, #document.skn-trz9 .programline{font-size:13px}
            #document.skn-trz9 .name{color:{{isset($resume->color)? $resume->color:"#d3d3d3"}};font-size:{{isset($resume->nameSize)? $resume->nameSize:"35px"}};line-height:60px;margin-top:60px;padding-left:{{isset($pdf_view)?'20':'0'}}px;}
            #document.skn-trz9 .heading{line-height:22px}
            #document.skn-trz9 .sectiontitle{font-size:16px;color:{{isset($resume->color)? $resume->color:"#dc3545"}};text-transform:uppercase;}
            #document.skn-trz9 .right-box .paragraph .singlecolumn{margin-left:51px}
            #document.skn-trz9 svg{stroke:#002e58}
            #document.skn-trz9 .resumeTitle{font-size:16px;color:#002e58;line-height:16px;padding-left:{{isset($pdf_view)?'20':'0'}}px}
			...
			#document.skn-trz9 .main{font-size:16px;color:#fff;line-height:16px; padding-top:25px;padding-left:25px;}
			 ...
			 .parentContainer .right-box {width: 41%;}
			...
			.row.about-container .resume-preview.thumb-preview.resume-animation #document .topsection {}
         progress {
            /* display:none ;  */
         ...
         .rename-section{
            ...
            @media only screen and (max-width: 1386px) {
               ...
               @if(isset($pdf_view))
               #CONTAINER_0.right-box .sortable-item{
	  ...
	  <div id="CONTAINER_PARENT" class="topaddress  editcontent " dhref="@if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif" style="height:72px;margin-top: 35px;width:100%;">

		<div id="top-1" style="width:30%;float:left;">


		<div dependency="HPHN" style="padding-left:26px">

											<h5 style="font-weight:bold;font-size:15px;color:{{isset($resume->color)?$resume->color:'#dc3545'}};" class="address10">Phone</h5>
                                             <span class="field" id="FIELD_HPHN">{{ $resume->phone ?? '916-948-7196' }}</span>
                                          </div>
		</div>
		<div id="top-2" style="width:30%;float:left;">

										<div dependency="EMAI" class="word-break" style="text-align:left;">
										  <h5 style="font-weight:bold;font-size:15px;color:{{isset($resume->color)?$resume->color:'#dc3545'}};" class="address10">E-mail</h5>
                                             <span class="field" id="FIELD_EMAI">{{ $resume->email ?? 'example@gmail.com' }}</span>
                                          </div>
		</div>
		<div id="top-3" style="width:30%;float:left;margin-left:42px;">

										<div dependency="STRT|CITY|STAT|ZIPC" style="padding-right:20px">
									   		<h5 style="font-weight:bold;font-size:15px;color:{{isset($resume->color)?$resume->color:'#dc3545'}}" class="address10">Address</h5>
         ...
         <div id="CONTAINER_PARENT_-1" class="topsection"  >
			<div class="">
			<div id="CONTAINER_4" class="left-box scvt" style="width:{{ isset($pdf_view)? '75%':'70%'}}; {{isset($pdf_view)?'height:170px;':'height:auto;min-height:170px;'}}background-color:{{isset($resume->backgroundColor)? $resume->backgroundColor:'#dc3545'}};">
               <div data-react-beautiful-dnd-draggable="0" class="sortable-item section-container SortableItem-sibling  data-NAME">
                  ...
                  <div id="SECTION_NAME464b9aab-d77c-4f2a-994a-4f79aa785951" class="section 	main SECTION_NAME firstsection  " data-section-cd="NAME">
                     <div class=" doc-item editcontent " dhref="@if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif">
                        <div class="">
                           <div class="">
						   <div class="name word-break" style="line-height:33px;">
                              ...
                              <div class="resumeTitle" style="color:{{isset($resume->color)?$resume->color:'#d3d3d3'}}"id="FIELD_DCTL">{{ $resume->profession ?? 'Developer' }}</div>
                           </div>
                        </div>
                     </div>
                  </div>
			...
			<div id="CONTAINER_3" class="right-box" style="width:{{ isset($pdf_view)? '25%':'30%'}};">
               <div data-react-beautiful-dnd-draggable="0" class="sortable-item section-container SortableItem-sibling  data-NAME">
                  <div class="document-tool sec-tool" id="editIcons" style="right: -22px;"></div>
                     ...
                     <div class=" doc-item">
                        <div class="">
                         ...
                         @if(isset($resume->image))
									<img src="{{ url('images/resumeImages/') }}/{{ $resume->image }}"  style="width:100%;height:170px;">  
									@else
									<img src="{{ url('asset_new/img/user/profile.png')}}" style="width:100%;height:170px;"/>
									@endif
		 ...
		 <div id="CONTAINER" class="parentContainer" style="width:100%;clear:both;">
            <div id="CONTAINER_0" class="left-box" style="width:60%; float:left;clear:both">
			...
			<div class="sortableInner">
              <div data-react-beautiful-dnd-draggable="0" class="sortable-item section-container SortableItem-sibling  data-SUMM left-side" >
                     ...
                     <div class=" doc-item editcontent " dhref="@if(isset($resume->id))  {{ route('editEducationList',['id' => $resume->id]) }} @endif">
						...
						@if(isset($resume->resume_education_detail) && $resume->resume_education_detail)
							@foreach($resume->resume_education_detail as $education)
							 <div id="PARAGRAPH_EDUC_0" class="paragraph datespara PARAGRAPH_EDUC firstparagraph placeholder-text " style="position: relative;{{$loop->iteration > 1 ?'padding-top:10px;':''}}">
								<div class="clearfix doc-item">
								   <div class="singlecolumn" style="text-align: justify;width: 100%;">
									  <!-- <div class="paddedline date-content" style="padding-top: 0px;">
                             ...
                             <span class="degree" id="FIELD_DGRE" style="font-size:13px;font-weight:bold;display: inline-block;width: 65%;">{{ $education->degree }}</span>
                             <span class="jobdates" id="FIELD_GRED" format="%Y-%m" style="position: absolute;margin-left: 10px;display: inline-block;">{{ date('M, Y', strtotime($education->graduation_start_date)) }}-{{ $education->current == '1' ? 'Current' : date('M, Y', strtotime($education->graduation_end_date)) }}</span>
										  <span dependency="JSTD+EDDT"></span>
										  <span class="jobdates" id="FIELD_EDDT" format="%Y-%m"></span>
                                       </span>
                        ...
                        <div class="">
						  ...
						  @if(isset($resume->resume_work_detail) && $resume->resume_work_detail)
							@foreach($resume->resume_work_detail as $workhistory)
                              <div id="PARAGRAPH_EXPR_0" class=" PARAGRAPH_EXPR firstparagraph placeholder-text" style="{{$loop->iteration > 1 ?'padding-top:10px;':''}}">
                                 <div class="clearfix doc-item">
                                     <span class="paddedline" dependency="JTIT">
                                       <span class="jobtitle txtBold" id="FIELD_JTIT" style="display: inline-block;width: 65%;">{{  $workhistory->job_title  }} </span>
									   <span class="jobdates" id="FIELD_JSTD" format="%Y-%m" style="position: absolute;margin-left: 10px;display: inline-block;">{{ date('M, Y', strtotime($workhistory->start_date)) }} - {{ $workhistory->is_current == '1' ? 'Current' : date('M, Y', strtotime($workhistory->end_date)) }}</span>
										  <span dependency="JSTD+EDDT"></span>
										  <span class="jobdates" id="FIELD_EDDT" format="%Y-%m"></span>
                                       </span>
						  ...
						  @else
                              ...
                              <div id="PARAGRAPH_EXPR_-2" class="paragraph PARAGRAPH_EXPR placeholder-">
                                 <div class="clearfix doc-item">
                                    <div class="singlecolumn">
			   ...
			   <div id="CONTAINER_0" class="right-box sortableInner" style="width:40%;padding-right:5px;">
                  <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-HILT">
                  <div class="document-tool sec-tool" id="editIcons" style="-22px"></div>
                  <div id="SECTION_HILT78287197-6649-4595-8d7a-51b01fd1ff77" class="section SECTION_HILT  noparagraph " data-section-cd="HILT" style="padding-left:-200px;">
                     <div class=" doc-item editcontent " dhref="@if(isset($resume->id))  {{ route('edit-skills',['id' => $resume->id]) }} @endif">
                        <div class="heading">
                           <div class="sectiontitle" id="SECTIONNAME_HILT" style="margin-top:0px;">@if(isset($resume->skills)) {{!empty($resume->skills->section_title)?$resume->skills->section_title : 'SKILLS'}} <span class="rename-section text-rename text-primary"> RENAME </span>
                                 ...
                                 <div class="doc-item">
                                    <div class="ratingRow">
                                       <div class="ratingText" id="FIELD_SKC1">
                                          <ul  @if(isset($pdf_view)) style="width:200px;" @endif>
                                     ...
                                     @if(!empty($skills[0]->skill))  
													@foreach($skills as $skill)
														<li>{{ $skill->skill }}<div style = "width: 100px; background: #fe7a66;border:1px solid #307c7b; position: relative; padding: 0px;">
     <div  style="height: 5px; background-color: #dc3545; width: {{ (int)$skill->rating * 2}}0%;"></div></div></li>
													@endforeach
                                       @else
			   ...
			   <div class="section-container " style="padding-left:-200px">
				<div class="doc-item  editcontent " dhref="@if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif">	 	
            ...
            @if( ( !empty($resume->facebook) ) || ( !empty($resume->twitter) ) || ( !empty($resume->linkedin) ) || ( !empty($resume->website) ) )
                     ...
                     <div class="heading" style="margin-top:10px;">
								...
								<div class="social_links" style="{{isset($pdf_view)?'width:190px;':''}}">
									@if( $resume->facebook != '' )
            ...
            <div class="sortable-item section-container SortableItem-sibling  data-SEC">
					 <div id="SECTION_EDUC411a31aa-7167-4080-837f-be30a3388e31" class="section education SECTION_EDUC  noparagraph multi-para" data-section-cd="SEC">
						<div class=" doc-item editcontent " dhref="@if(isset($resume->id))  {{ route('edit-section',['id' => $resume->id]) }} @endif">
						   <div class="heading">
							  <div class="sectiontitle" id="SECTIONNAME_SEC" style="margin-top:10px;">@if(isset($resume->extraSection->title)) {{$resume->extraSection->title}} <span class="rename-section text-rename text-primary">Rename</span>
						   ...
						   <div class="">
							  <div class="" style="text-align:justify;width: 90%;">
