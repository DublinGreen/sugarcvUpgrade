                     ...
                     <div class=" doc-item editcontent " dhref=" @if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif">
                        <div class="">
						   ...
						   <div class="name word-break" style="text-transform:uppercase">
									...
									<div style="width: 100%;text-align: center;line-height: 40px;border-bottom: 1px solid #4267B2;color: #DAA520;margin-top: -22px;font-weight:bold">{{$resume->profession ?? 'Designer'}}</div>
                              <!--<div class="resumeTitle " id="FIELD_DCTL" style="border-bottom:1px solid #4267B2;color:#DAA520;">{{$resume->profession ?? 'Designer'}}</div>-->
