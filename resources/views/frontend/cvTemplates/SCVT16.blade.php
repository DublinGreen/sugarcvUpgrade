   ...
   <div class="">
      <div>
         ...
         #backgroundInactive{
            ...
            #document.skn-trz7 .name{color:#fff;font-weight:bold;padding:0 0 6px 0;font-style:arial;text-align:right;position:relative;padding-right:20px;word-break:break-word;text-transform:uppercase;}
            #document.skn-trz7 .address .singlecolumn{margin-left:0!important}
            #document.skn-trz7 .resumeTitle{color:#fff;font-style:arial;font-weight:400;padding-right:5px;text-transform:uppercase;}
            /* Heading */
            #document.skn-trz7 .heading{padding:0 0 3px;letter-spacing:0;font-weight:bold;line-height:15px;padding-bottom:5px;padding-top:15px;}
            ...
            #document.skn-trz7 .right-box .paddedline.date-content{/*position:absolute;margin-left:-67px;width:55px;*/font-weight:700;background-color:#BE00FE;color:#fff;}
			...
			#document.skn-trz7 .topsections .left-box {float: left;padding-bottom: 0;padding-left: 0;padding-right: 0;width: 50%;}
			...
			#document .topsections .headimg{background:red; width: 100%; padding-left:0px !important; padding-right:0px !important; margin-top:0px}
         ...
         <style type="text/css" id="dynamic" data-time="Tue May 26 2020 17:35:58 GMT+0530 (India Standard Time)">
            ...
            #document.skn-trz7 .resumeTitle{font-size:16px;color:#002e58;line-height:16px;text-align:right}
			...
			#document .topsections .headimg{background:#fff; width: 100%; padding-left:0px !important; padding-right:0px !important;}
			...
			ul.ba {    list-style-type: none;}
			 ...
			 #document.skn-trz7 .topleft{background:#6A0DAD;height:160px;width:37.9%;float:left;}
			 #document.skn-trz7 .topright{background:#6A0DAD;height:130px;width:62%;float:right;}
			 
			 
			 #document.skn-trz7 .shape{width:5px; height:80px;transform:skewX(40deg);background-color:#fff;float:right;margin-right:10px;}
			 #document.skn-trz7 .shape1{width:5px; height:100px;transform:skewX(40deg);background-color:#fff;float:right;margin-right:12px;}
			 #document.skn-trz7 .shape2{width:5px; height:120px;transform:skewX(40deg);background-color:#fff;float:right;margin-right:12px;}
			 #document.skn-trz7 .shape3{width:5px; height:130px;transform:skewX(40deg);background-color:#fff;float:right;margin-right:15px;}
			 
			 
			 #document.skn-trz7 .singlecolumn1{margin-left:68px;margin-bottom:10px}
            ...
            @else
            .row.about-container .resume-preview.thumb-preview.resume-animation #document.vmargins{width:617px!important}
            @endif
			 ...
			 .row.about-container .resume-preview.thumb-preview.resume-animation #document.skn-trz7 .parentContainer .right-side {width: 387px!important;}
			 .row.about-container .resume-preview.thumb-preview.resume-animation #document.skn-trz7 .topsections {width: 611px!important;}
			 
			 .header_image{position: relative;top: -66px;}
			 .scvt{
		  background-color:{{isset($resume->backgroundColor)? $resume->backgroundColor:'#6A0DAD'}};
     ...
     .rename-section{
	  ...
	  <!---------header---------------->
      <div id="document" class="document fontsize fontface vmargins  pagesize skn-trz7 TRZ7  ZTY" style='width:100%;font-size:{{isset($resume->fontSize)? $resume->fontSize:"11px"}};font-family:{{isset($resume->fontFamily)? $resume->fontFamily:"Century Gothic"}};line-height:{{isset($resume->lineSpacing)? $resume->lineSpacing:"18px"}};'>
         <div id="CONTAINER_PARENT_-1" class="topsections" style="width:100%;float:left">
			<div class="headimg" style="width:100%;">
			<div class="topleft" style="width:40%;height:{{isset($pdf_view)?'160px':'auto;min-height:160px'}};">
		 ...
		 <!--div id="bottom" style="width:90%; height:10px; background-color:#C0C0C0; margin:auto;margin-top:3px"></div-->
     
         <div id="CONTAINER_PARENT_1" class="parentContainer" style="clear:both;">
            <div id="CONTAINER_1" class="left-box left-side" style="clear:both;width:38%">
			 <div class="sortableInner">
               <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-CNTC">
                  ...
                  <div id="SECTION_CNTC4b959b3f-7a77-4285-9b17-82823b7d38a8" class="section SECTION_CNTC notdraggable   " data-section-cd="CNTC">
                     <div class=" doc-item editcontent " dhref="@if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif">
                        <div class="heading">
                           <div class="sectiontitle" id="SECTIONNAME_CNTC" style='font-size:16px;color:{{isset($resume->color) ? $resume->color:"#fff"}};background-color:#6A0DAD;border:2px solid #BE00FE;padding-left:5px;text-transform:uppercase;'>{{!empty($resume->contact_section_title)?$resume->contact_section_title:'CONTACT'}}<span class="rename-section text-rename text-primary"> RENAME</span>
			   ...
			   <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-HILT editcontent " dhref="@if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif" style="margin-top:0px;">
			   <div class="heading">
                           <div class="sectiontitle" id="SECTIONNAME_HILT" style='font-size:16px;color:{{isset($resume->color) ? $resume->color:"#fff"}};background-color:#6A0DAD;border:2px solid #BE00FE;padding-left:5px;text-transform:uppercase;'>{{!empty($resume->bio_section_title)?$resume->bio_section_title:'BIO DATA'}}<span class="rename-section text-rename text-primary"> RENAME</span>
               ...
               <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-HILT">
                  ...
                  <div id="SECTION_HILT78287197-6649-4595-8d7a-51b01fd1ff77" class="section SECTION_HILT  noparagraph " data-section-cd="HILT">
                        ...
                        <div class="heading">
                           <div class="sectiontitle" id="SECTIONNAME_HILT" style='font-size:16px;color:{{isset($resume->color) ? $resume->color:"#fff"}};background-color:#6A0DAD;border:2px solid #BE00FE;padding-left:5px;text-transform:uppercase;'>@if(isset($resume->skills)) {{!empty($resume->skills->section_title)?$resume->skills->section_title : 'SKILLS'}} <span class="rename-section text-rename text-primary"> RENAME </span>
                                       ...
                                       <div class="ratingText" id="FIELD_SKC1">
                                          ...
                                          @if(isset($resume->skills) && $resume->skills)
                                                   ...
                                                   @foreach($skills as $skill)
                                                      <li style="margin: 0;list-style: none;{{$loop->iteration > 1 ? 'padding-top:8px;':''}}">{{ $skill->skill }}</li>
                                                   @endforeach
                                                   @else
               ...
               <div class="sortable-item section-container SortableItem-sibling  data-SOCL editcontent " dhref=" @if(isset($resume->id)) {{ route('edit-resume',['id' => $resume->id]) }} @endif" style="">
                  <div class="heading" style="">
                     <div class="sectiontitle" id="SECTIONNAME_SOCL" style='font-size:16px;color:{{isset($resume->color) ? $resume->color:"#fff"}};background-color:#6A0DAD;border:2px solid #BE00FE;padding-left:5px;text-transform:uppercase;'>Social Links<span class="inner-action"><a href="@if(isset($resume->id))  {{ route('edit-resume',['id' => $resume->id]) }} @endif" class="edit-section"><i class="fa fa-pencil"></i></a> <a href="javascript:;" class="btn-icon-tertiary btn-icon-move" style="right: -476px;"><i class="fa fa-arrows-alt" tabindex="0" data-react-beautiful-dnd-drag-handle="1" aria-roledescription="Draggable item. Press space bar to lift" draggable="false"></i></a></span></div>
                  </div>
            ...
            <div id="CONTAINER_2" class="right-box right-side" style="clear:both;width:70%;">
			<div class="sortableInner">
                        ...
                        <div class="">
                           <div class="">
                              <div id="PARAGRAPH_SUMM_0" class="paragraph PARAGRAPH_SUMM firstparagraph placeholder-text ">
                                 ...
                                 <div class="clearfix doc-item">
								 <div class="heading">
								   <div class="sectiontitle" id="" style='font-size:16px;color:{{isset($resume->color) ? $resume->color:"#fff"}};background-color:#6A0DAD;border:2px solid #BE00FE;padding-left:5px;text-transform:uppercase;'>@if(isset($resume->summary)) {{!empty($resume->summary->section_title)?$resume->summary->section_title : 'Profile'}}<span class="rename-section text-rename text-primary"> RENAME</span>
                              <span class="titleupdate" style="display:none;"><input type="text" data-link="aboutme" value="{{!empty($resume->summary->section_title)?$resume->summary->section_title : 'Profile'}}" ><span class="eduname"><i class="fa fa-check"></i></span> <span class="cancel">Cancel</span></span>@else Profile @endif <span class="inner-action" data-resumeId="{{ isset($resume->id)? $resume->id:''}}" data-href="{{route('deletesummary')}}"><a href="javascript:;" class="del-section"><i class="fa fa-trash"></i></a> <a href="@if(isset($resume->id)) {{ route('edit-summary',['id' => $resume->id]) }} @endif" class="edit-section"><i class="fa fa-pencil"></i></a> <a href="javascript:;" class="btn-icon-tertiary btn-icon-move" style="right: -476px;"><i class="fa fa-arrows-alt" tabindex="0" data-react-beautiful-dnd-drag-handle="1" aria-roledescription="Draggable item. Press space bar to lift" draggable="false"></i></a></span></div>
                                    ...
                                    <div class="field singlecolumn" id="FIELD_FRFM" style="margin-left: 10px;">@if(isset($resume->summary) && $resume->summary)
               ...
               <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-EXPR">
                  ...
                  <div id="SECTION_EXPR06fafd67-c5ae-45e8-b4a1-ed0f75d06194" class="section experience SECTION_EXPR  noparagraph multi-para" data-section-cd="EXPR">
                     <div class=" doc-item editcontent " dhref="@if(isset($resume->id)) {{ route('editExprList',['id' => $resume->id]) }} @endif">
                        <div class="heading">
                           <div class="sectiontitle" id="SECTIONNAME_EXPR" style='font-size:16px;color:{{isset($resume->color) ? $resume->color:"#fff"}};background-color:#6A0DAD;border:2px solid #BE00FE;padding-left:5px;text-transform:uppercase;' >@if(isset($resume->resume_work_detail[0])) {{!empty($resume->resume_work_detail[0]->section_title)?$resume->resume_work_detail[0]->section_title : 'EXPERIENCE'}}<span class="rename-section text-rename text-primary"> RENAME</span>
						  ...
						  @if(isset($resume->resume_work_detail) && $resume->resume_work_detail)
							@foreach($resume->resume_work_detail as $workhistory)
                              <div id="PARAGRAPH_EXPR_0" class="paragraph PARAGRAPH_EXPR firstparagraph placeholder-text ">
                                 <div class="clearfix doc-item">
                                    <div class="singlecolumn" style="width: 100%;display: inline-block;{{isset($pdf_view)?'padding-top:15px;':'padding-top:10px;'}}">
									<!--div class="paddedline date-content" dependency="JSTD|EDDT" style="height: 91px;">
                                       ...
                                       <div class="paddedline date-content" dependency="JSTD|EDDT" style="padding:3px;height:auto;width: {{isset($pdf_view)?'15%;margin-top:0px !important;':'17%;'}}display: inline-block;">
									   ...
									   <div style="/* margin-left: 14px; */width: {{isset($pdf_view)?'81%;margin-top:-10px !important;padding-bottom: 2px;':'79%;'}};display: inline-block;vertical-align: top;padding-left: 5%;">
                              ...
                              <div id="PARAGRAPH_EXPR_-1" class="paragraph PARAGRAPH_EXPR placeholder-text ">
                                 <div class="clearfix doc-item">
                                    <div class="singlecolumn1">
                                       <div class="paddedline date-content" dependency="JSTD|EDDT" style="padding:3px;">
                                          <span class="jobdates" id="FIELD_JSTD" format="%Y-%m">06/2013</span><span dependency="JSTD+EDDT"> - </span><span class="jobdates" id="FIELD_EDDT" format="%Y-%m">03/2015</span>
                                       </div>
									   <div style="">
										   <span class="paddedline" dependency="JTIT">
               ...
               <div data-react-beautiful-dnd-draggable="1" class="sortable-item section-container SortableItem-sibling  data-EDUC">
                  ...
                  <div id="SECTION_EDUCe38830c3-809a-48c9-a15b-57e04eb83e0e" class="section education SECTION_EDUC  noparagraph multi-para" data-section-cd="EDUC">
                     <div class=" doc-item editcontent " dhref="@if(isset($resume->id))  {{ route('editEducationList',['id' => $resume->id]) }} @endif">
                        <div class="heading">
                           <div class="sectiontitle" id="SECTIONNAME_EDUC" style='font-size:16px;color:{{isset($resume->color) ? $resume->color:"#fff"}};background-color:#6A0DAD;border:2px solid #BE00FE;padding-left:5px;text-transform:uppercase;{{isset($pdf_view)?'margin-top:-35px !important;':''}}'>@if(isset($resume->resume_education_detail[0])) {{!empty($resume->resume_education_detail[0]->section_title)?$resume->resume_education_detail[0]->section_title : 'EDUCATION'}}<span class="rename-section text-rename text-primary"> RENAME</span>
                        ...
                        <div class="">
						  ...
						  @if(isset($resume->resume_education_detail) && $resume->resume_education_detail) 
							@foreach($resume->resume_education_detail as $education)
							 <div id="PARAGRAPH_EDUC_0" class="paragraph datespara PARAGRAPH_EDUC firstparagraph placeholder-text ">
								<div class="clearfix doc-item">
								   <div class="singlecolumn" style="width: 100%;display: inline-block;{{isset($pdf_view)?'padding-top:25px;':'padding-top:10px;'}}">
									  <div class="paddedline date-content" style="padding:3px;height:auto;width: {{isset($pdf_view)?'15%;margin-top:0px !important;':'17%;'}}display: inline-block;">
									  ...
									  <div style="width: {{isset($pdf_view)?'81%;margin-top:-10px !important;padding-bottom: 2px;':'79%;'}}display: inline-block;vertical-align: top;padding-left: {{isset($pdf_view)?'7%;':'5%'}};">
						  ...
						  @else
							 <div id="PARAGRAPH_EDUC_0" class="paragraph datespara PARAGRAPH_EDUC firstparagraph placeholder-text ">
								<div class="clearfix doc-item">
								   <div class="singlecolumn1">
									  <div class="paddedline date-content" style="height: 91px;padding:3px;">
			  ...
			  <div class="sortable-item section-container SortableItem-sibling  data-SEC">
				 <div id="SECTION_EDUC411a31aa-7167-4080-837f-be30a3388e31" class="section education SECTION_EDUC  noparagraph multi-para" data-section-cd="SEC">
					<div class=" doc-item editcontent " dhref="@if(isset($resume->id))  {{ route('edit-section',['id' => $resume->id]) }} @endif">
					   <div class="heading">
						  <div class="sectiontitle" id="SECTIONNAME_SEC" style='font-size:16px;color:{{isset($resume->color) ? $resume->color:"#fff"}};margin-top:{{isset($pdf_view)?'-35px !important':'10px'}};background-color:#6A0DAD;border:2px solid #BE00FE;padding-left:5px;text-transform:uppercase;'>@if(isset($resume->extraSection->title)) {{$resume->extraSection->title}} <span class="rename-section text-rename text-primary">Rename</span>
					   ...
					   <div class="">
						  <div class="" style="padding-left:10px;{{isset($pdf_view)?'padding-top:15px !important;':''}}">
