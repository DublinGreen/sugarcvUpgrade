...
<html><head skincd="TRZ9"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <!--START DEFAULT VALUES-->
    </head><body><default name="PGSZ" content="Letter">
    <default name="FTFC" content="Century Gothic">
    <default name="VMRG" content="13">
    <default name="HMRG" content="13">
    ...
    <default name="SDCL" content="#003d74">
    <!--END DEFAULT VALUES-->
	...
	<!-- <formula name="BRML" content="153 - {$PIND}" /> -->
    <formula name="RBOX" content="144">
    <!--END Calculation-->

    <container parentindex="0" index="0" value="NAME,SUMM">
    <container parentindex="1" index="1" value="*" class="left-box">
    <container parentindex="1" index="2" value="CNTC,HILT,SFTR" class="right-box">
    ...
    <style type="text/css" id="static">
        ...
        #document.skn-trz9 .left-box .paddedline.date-content{position:absolute;font-weight:700;margin-left:0;width:65px}
    ...
    <style type="text/css" id="dynamic" leftcolwidth="0">
        #document.skn-trz9,#document.skn-trz9 table{line-height:{$FTLH}px}
        #document.skn-trz9.pagesize{width:{$PGSZ}px}
        #document.skn-trz9.fontface{font-family:{$FTFC}}
        #document.skn-trz9.fontsize{font-size:{$FTSZ}px}
        #document.skn-trz9.vmargins{padding-top:{$TBMR}px;padding-bottom:{$TBMR}px}
        #document.skn-trz9.hmargins{padding-left:{$LRMR}px;padding-right:{$LRMR}px}
        #document.skn-trz9 .section{padding-top:{$SCSP}px}
        #document.skn-trz9 .right-box .section:after{padding-bottom:{$SSPC}px}
        #document.skn-trz9 .paragraph{margin-top:{$PSPC}px}
        #document.skn-trz9 .rtngSec .paragraph{margin-top:{$RTNG}px; page-break-inside:avoid;}
        #document.skn-trz9 .singlecolumn,#document.skn-trz9 .maincolumn{word-wrap:break-word}
        #document.skn-trz9 .left-box .singlecolumn,#document.skn-trz9 .left-box .maincolumn{margin-left:{$PIND}px}
        #document.skn-trz9 table.skills td{padding-top:{$TDMT}px}
        #document.skn-trz9 .jobtitle, #document.skn-trz9 .degree, #document.skn-trz9 .programline{font-size:{$JTTL}px}
        #document.skn-trz9 .name{color:{$SDCL};font-size:{$NMSZ}px;line-height:{$NMLH}px}
        #document.skn-trz9 .heading{line-height:{$HDLH}px}
        #document.skn-trz9 .sectiontitle, #document.skn-trz9 .resumeTitle{font-size:{$HDSZ}px;color:{$SDCL}}
        #document.skn-trz9 .right-box{width:{$RBOX}px}
        #document.skn-trz9 .left-box .paragraph .singlecolumn{margin-left:{$PMAR}px}
		#document.skn-trz9 .left-box .paddedline.date-content{left:-{$PMAR}px}
        /*Icon*/
        #document.skn-trz9 .headingIcon svg rect{fill:{$SDCL}}

        /* Bar Graph */
        #document.skn-trz9 .innerRating{background-color:{$SDCL}}
        /*fixes for builder*/
        #document.skn-trz9 .left-box > .SortableItem-sibling,
        #document.skn-trz9 .right-box > .SortableItem-sibling{padding-top:{$SCSP}px}
    ...
    <div id="document" class="skn-trz9 fontsize fontface vmargins hmargins pagesize">
                    ...
                    <div class="paragraph" id="PARAGRAPH_LANG">
                        <div class="singlecolumn">
                            ...
                            <div class="ratingBar" dependency="RATV">
                                <div class="innerRating" id="FIELD_RATV" type="width"></div>
                            </div>
            ...
            <div id="CONTAINER_2" class="right-box last-box">
                <div id="SECTION_CNTC" class="section SECTION_CNTC notdraggable">
                    <div class="heading">
                        ...
                        <span class="sectiontitle" id="SECTIONNAME_CNTC">Contact Info</span>
                    </div>
