(function ( $ ) {
    ...
    $.fn.richText = function( options ) {
        ...
        var $editor,
            ...
            $btnFont = $('<a />', {class: "richText-btn","data-command": "fonts", "title": settings.translations.addFont, html: '<span class="fa fa-font"></span>'}), // font color
        ...
        $(document).on("click", ".richText-toolbar a[data-command]", function(event) {
            ...
            $button.parents('li.is-selected').addClass('is-selected');
		...
		$(document).on("click", "#list_group li", function(event) {

			var parent = $(this).attr('id');
			var content = $("#"+parent+" .example-text").text().trim();
			// restoreSelection(editorID, true);
			content = '<ul><li id="cli_'+parent+'">'+content+'</li></ul>\n';
			if ($(this).hasClass('selected')) {
				$(this).removeClass('selected')
				// jQuery("#"+editorID).find("#cli_"+parent).remove();
				jQuery(".richText-editor #cli_"+parent).remove();
			} else{
				 //pasteHTMLAtCaret(content);
				 $(".richText-editor").append(content);
